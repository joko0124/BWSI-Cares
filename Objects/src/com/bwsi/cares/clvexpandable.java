...
public class clvexpandable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.cares.clvexpandable");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.cares.clvexpandable.class).invoke(this, new Object[] {null});
        else
...
_title = _pnl.GetView((int) (0));
 //BA.debugLineNum = 73;BA.debugLine="Dim iv As B4XView = title.GetView(2) 'ImageView1";
_iv = new anywheresoftware.b4a.objects.B4XViewWrapper();
_iv = _title.GetView((int) (2));
...
public com.bwsi.cares.clvexpandable._expandableitemdata  _createvalue(anywheresoftware.b4a.objects.B4XViewWrapper _pnl,Object _value) throws Exception{
...
_e = new com.bwsi.cares.clvexpandable._expandableitemdata();
...
if (_mclv._getvalue(_index) instanceof com.bwsi.cares.clvexpandable._expandableitemdata) { 
 //BA.debugLineNum = 23;BA.debugLine="Dim e As ExpandableItemData = mCLV.GetValue(Inde";
_e = (com.bwsi.cares.clvexpandable._expandableitemdata)(_mclv._getvalue(_index));
...
public ResumableSub_ResizeItem(com.bwsi.cares.clvexpandable parent,int _index,boolean _collapse) {
this.parent = parent;
this._index = _index;
this._collapse = _collapse;
}
com.bwsi.cares.clvexpandable parent;
int _index;
boolean _collapse;
b4a.example3.customlistview._clvitem _item = null;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
anywheresoftware.b4a.objects.B4XViewWrapper _newpanel = null;
com.bwsi.cares.clvexpandable._expandableitemdata _id = null;
int _newsize = 0;
...
//if
this.state = 6;
if (_p.getNumberOfViews()==0 || (_item.Value instanceof com.bwsi.cares.clvexpandable._expandableitemdata)==parent.__c.False) { 
this.state = 3;
;}if (true) break;
...
_id = (com.bwsi.cares.clvexpandable._expandableitemdata)(_item.Value);
...
public com.bwsi.cares.clvexpandable._expandableitemdata  _toggleitem(int _index) throws Exception{
com.bwsi.cares.clvexpandable._expandableitemdata _i = null;
 //BA.debugLineNum = 78;BA.debugLine="Public Sub ToggleItem (Index As Int) As Expandable";
 //BA.debugLineNum = 79;BA.debugLine="Dim i As ExpandableItemData = mCLV.GetValue(Index";
_i = (com.bwsi.cares.clvexpandable._expandableitemdata)(_mclv._getvalue(_index));
...
_expanditem(_index);
 ...
 //BA.debugLineNum = 85;BA.debugLine="Return i";
if (true) return _i;
