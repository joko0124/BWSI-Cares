...
anywheresoftware.b4a.keywords.Common.LogImpl("36094863","CreateTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36946821","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36946831","DeleteRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36160387","DropTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36750215","ExecuteHtml: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36684680","ExecuteJSON: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36684697","Invalid type: "+BA.ObjectToString(_dbtypes.Get(_i)),0);
 break; }
}
;
 }
...
anywheresoftware.b4a.keywords.Common.LogImpl("36488071","ExecuteMap: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36488073","No records found.",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36422535","ExecuteMemoryTable: "+_query,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36225924","Same Map found twice in list. Each item in the list should include a different map object.",0);
...
if (_i1==0) { 
anywheresoftware.b4a.keywords.Common.LogImpl("36225952","InsertMaps (first query out of "+BA.NumberToString(_listofmaps.getSize())+"): "+_sb.ToString(),0);};
...
anywheresoftware.b4a.keywords.Common.LogImpl("36225958",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(_ba)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("36291462","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36291473","UpdateRecord: "+_sb.ToString(),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36356994","WhereFieldEquals map empty!",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36356998","Fields empty",0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("36357023","UpdateRecord: "+_sb.ToString(),0);
