...
public class bbcodeparser extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.cares.bbcodeparser");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.cares.bbcodeparser.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public com.bwsi.cares.b4xset _allowedtags = null;
...
_allowedtags = new com.bwsi.cares.b4xset();
...
public anywheresoftware.b4a.objects.collections.List  _createruns(anywheresoftware.b4a.objects.collections.List _texts,com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) throws Exception{
anywheresoftware.b4a.objects.collections.List _runs = null;
com.bwsi.cares.bbcodeparser._bbcodetextnode _textnode = null;
...
_textnode = (com.bwsi.cares.bbcodeparser._bbcodetextnode)(group3.Get(index3));
...
public com.bwsi.cares.bbcodeparser._bbcodetagnode  _createtagnode(String _tag) throws Exception{
com.bwsi.cares.bbcodeparser._bbcodetagnode _n = null;
...
_n = new com.bwsi.cares.bbcodeparser._bbcodetagnode();
...
public com.bwsi.cares.bbcodeparser._bbcodetextnode  _createtextnode(String _text) throws Exception{
com.bwsi.cares.bbcodeparser._bbcodetextnode _n = null;
...
_n = new com.bwsi.cares.bbcodeparser._bbcodetextnode();
...
__c.LogImpl("917563651",_s,__c.Colors.Red);
 //BA.debugLineNum = 161;BA.debugLine="ErrorString.Append(s).Append(CRLF)";
_errorstring.Append(_s).Append(__c.CRLF);
 //BA.debugLineNum = 162;BA.debugLine="End Sub";
return "";
}
public int  _getdimensionfromtag(com.bwsi.cares.bbcodeparser._bbcodetagnode _tag,String _key,com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _s = "";
int _i = 0;
float _v = 0f;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getview(com.bwsi.cares.bbcodeparser._bbcodetagnode _tag,com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _id = "";
...
public com.bwsi.cares.bctextengine._bctextrun  _handlelistelement(com.bwsi.cares.bbcodeparser._bbcodetextnode _text,com.bwsi.cares.bctextengine._bctextrun _run) throws Exception{
int _i = 0;
com.bwsi.cares.bbcodeparser._bbcodetagnode _tag = null;
String _liststyle = "";
int _count = 0;
...
_tag = (com.bwsi.cares.bbcodeparser._bbcodetagnode)(_text.Tags /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*com.bwsi.cares.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(((int)0x2022)))+" ");
 }else {
...
_parent = _mtextengine._createconnectedparent /*com.bwsi.cares.bctextengine._bctextrun*/ ();
 //BA.debugLineNum = 355;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*com.bwsi.cares.bctextengine._bctextchars*/ (BA.NumberToString((_count))+". ");
 //BA.debugLineNum = 356;BA.debugLine="Dim cr As BCConnectedRuns = parent.Extra.Get(m";
_cr = (com.bwsi.cares.bctextengine._bcconnectedruns)(_parent.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_mtextengine._extra_connectedruns /*String*/ )));
...
_cr.ConnectedWidth /*int*/  = (int) (_mtextengine._getfontmetrics /*com.bwsi.cares.bctextengine._bcfontmetrics*/ (_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/ ,_run.TextColor /*int*/ ).xWidth /*int*/ *3/(double)_mtextengine._mscale /*float*/ );
...
public String  _initialize(anywheresoftware.b4a.BA _ba,com.bwsi.cares.bctextengine _textengine) throws Exception{
innerInitialize(_ba);
...
public anywheresoftware.b4a.objects.collections.List  _parse(com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
com.bwsi.cares.bbcodeparser._bbcodetagnode _t = null;
com.bwsi.cares.bbcodeparser._bbcodetagnode _n = null;
...
public com.bwsi.cares.bbcodeparser._bbcodetagnode  _parsetag(String _tag) throws Exception{
com.bwsi.cares.bbcodeparser._bbcodetagnode _res = null;
int _i = 0;
int _last = 0;
String _c = "";
String _key = "";
...
public void  _setimageview(com.bwsi.cares.bbcodeparser._bbcodetagnode _tag,com.bwsi.cares.bctextengine._bctextrun _run,com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ResumableSub_SetImageView(com.bwsi.cares.bbcodeparser parent,com.bwsi.cares.bbcodeparser._bbcodetagnode _tag,com.bwsi.cares.bctextengine._bctextrun _run,com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) {
this.parent = parent;
this._tag = _tag;
this._run = _run;
this._data = _data;
}
com.bwsi.cares.bbcodeparser parent;
com.bwsi.cares.bbcodeparser._bbcodetagnode _tag;
com.bwsi.cares.bctextengine._bctextrun _run;
com.bwsi.cares.bbcodeparser._bbcodeparsedata _data;
String _url = "";
String _dir = "";
String _filename = "";
int _width = 0;
...
com.bwsi.cares.httpjob _j = null;
...
//C
this.state = 9;
_j = (com.bwsi.cares.httpjob) result[0];
;
...
public void  _jobdone(com.bwsi.cares.httpjob _j) throws Exception{
}
public com.bwsi.cares.bbcodeparser._bbcodetagnode  _stackpeek() throws Exception{
...
if (true) return (com.bwsi.cares.bbcodeparser._bbcodetagnode)(_stack.Get((int) (_stack.getSize()-1)));
...
public String  _stackpush(com.bwsi.cares.bbcodeparser._bbcodetagnode _tag) throws Exception{
...
public String  _texttorun(com.bwsi.cares.bbcodeparser._bbcodetextnode _text,anywheresoftware.b4a.objects.collections.List _runslist,com.bwsi.cares.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
int _i = 0;
com.bwsi.cares.bbcodeparser._bbcodetagnode _tag = null;
com.bwsi.cares.bctextengine._bcstyledunderline _uu = null;
String _url = "";
String _clr = "";
String _name = "";
...
_run = _mtextengine._createrun /*com.bwsi.cares.bctextengine._bctextrun*/ (_text.Text /*String*/ );
...
_uu = new com.bwsi.cares.bctextengine._bcstyledunderline();
 //BA.debugLineNum = 207;BA.debugLine="uu.Initialize";
_uu.Initialize();
 //BA.debugLineNum = 208;BA.debugLine="uu.Style = tag.Extra.GetDefault(\"style\", mTex";
_uu.Style /*String*/  = BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)("style"),(Object)(_mtextengine._defaultunderlinestyle /*com.bwsi.cares.bctextengine._bcstyledunderline*/ .Style /*String*/ )));
...
__c.LogImpl("917825853","Font missing from TextEngine.CustomFonts: "+_name,0);
 }else {
...
_parent = (com.bwsi.cares.bctextengine._bctextrun)(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("run")));
...
_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _mtextengine._createbctextchars /*com.bwsi.cares.bctextengine._bctextchars*/ (new String[]{BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))},(int) (0),(int) (1));
...
_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*com.bwsi.cares.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(_parsecodepoint(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))))));
