...
public anywheresoftware.b4a.objects.PanelWrapper _btnreg = null;
public anywheresoftware.b4a.objects.LabelWrapper _btnregister = null;
public anywheresoftware.b4a.objects.PanelWrapper _pnlregister = null;
public anywheresoftware.b4a.objects.LabelWrapper _regbtnregister = null;
public anywheresoftware.b4a.objects.EditTextWrapper _txtregconfirmpassword = null;
public anywheresoftware.b4a.objects.EditTextWrapper _txtregemail = null;
public anywheresoftware.b4a.objects.EditTextWrapper _txtregfullname = null;
public anywheresoftware.b4a.objects.EditTextWrapper _txtregpassword = null;
public anywheresoftware.b4a.objects.LabelWrapper _reglbllogin = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 101;BA.debugLine="CheckPermissions";
_checkpermissions();
 //BA.debugLineNum = 102;BA.debugLine="Activity.LoadLayout(\"landingpage\")";
mostCurrent._activity.LoadLayout("landingpage",mostCurrent.activityBA);
 //BA.debugLineNum = 103;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 104;BA.debugLine="SetStatusBarAndNavigationColor(0x7CD4D4D4)";
_setstatusbarandnavigationcolor(((int)0x7cd4d4d4));
 //BA.debugLineNum = 105;BA.debugLine="ShowSplash";
_showsplash();
 };
 //BA.debugLineNum = 107;BA.debugLine="tmrSplash.Initialize(\"DoSomething\",300)";
_tmrsplash.Initialize(processBA,"DoSomething",(long) (300));
 //BA.debugLineNum = 108;BA.debugLine="tmrSplash.Enabled = True";
_tmrsplash.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 109;BA.debugLine="scvMain.Visible = True";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 110;BA.debugLine="scvMain.Panel.LoadLayout(\"LandingContents\")";
mostCurrent._scvmain.getPanel().LoadLayout("LandingContents",mostCurrent.activityBA);
 //BA.debugLineNum = 111;BA.debugLine="scvMain.Panel.Height = pnlMain.Height";
mostCurrent._scvmain.getPanel().setHeight(mostCurrent._pnlmain.getHeight());
 //BA.debugLineNum = 112;BA.debugLine="PanelSelection.Initialize(\"PanelSelection\")";
mostCurrent._panelselection.Initialize(mostCurrent.activityBA,"PanelSelection");
 //BA.debugLineNum = 113;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 119;BA.debugLine="imgSlider.NumberOfImages = 4";
mostCurrent._imgslider._setnumberofimages /*int*/ ((int) (4));
 //BA.debugLineNum = 120;BA.debugLine="imgSlider.PrevImage";
mostCurrent._imgslider._previmage /*void*/ ();
 //BA.debugLineNum = 121;BA.debugLine="timer1.Initialize(\"Timer1\",3000)";
_timer1.Initialize(processBA,"Timer1",(long) (3000));
 //BA.debugLineNum = 122;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 124;BA.debugLine="SetStatusBarAndNavigationColor(GlobalVariables.Pr";
_setstatusbarandnavigationcolor((int) (mostCurrent._globalvariables._pricolor1 /*double*/ ));
 //BA.debugLineNum = 126;BA.debugLine="InitializeDatas";
_initializedatas();
 //BA.debugLineNum = 128;BA.debugLine="CreateItem";
_createitem();
 //BA.debugLineNum = 133;BA.debugLine="fabApply.IconDrawable = \"fab_add\"";
mostCurrent._fabapply.setIconDrawable("fab_add");
 //BA.debugLineNum = 134;BA.debugLine="fabApply.ColorNormal = GlobalVariables.PriColor2";
mostCurrent._fabapply.setColorNormal((int) (mostCurrent._globalvariables._pricolor2 /*double*/ ));
 //BA.debugLineNum = 135;BA.debugLine="fabApply.ColorPressed = GlobalVariables.PriColor3";
mostCurrent._fabapply.setColorPressed((int) (mostCurrent._globalvariables._pricolor3 /*double*/ ));
 //BA.debugLineNum = 136;BA.debugLine="fabApply.ColorRipple = GlobalVariables.PriColor1";
mostCurrent._fabapply.setColorRipple((int) (mostCurrent._globalvariables._pricolor1 /*double*/ ));
 //BA.debugLineNum = 137;BA.debugLine="fabApply.ButtonSize = 1";
mostCurrent._fabapply.setButtonSize((int) (1));
 //BA.debugLineNum = 141;BA.debugLine="fabApply.Indeterminate = True";
mostCurrent._fabapply.setIndeterminate(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 149;BA.debugLine="TextEngine.Initialize(Activity)";
mostCurrent._textengine._initialize /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())));
 //BA.debugLineNum = 150;BA.debugLine="Expandable.Initialize(clvServices)";
mostCurrent._expandable._initialize /*String*/ (mostCurrent.activityBA,mostCurrent._clvservices);
 //BA.debugLineNum = 151;BA.debugLine="bc.Initialize(Activity.Width, 40dip)";
mostCurrent._bc._initialize(processBA,mostCurrent._activity.getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 152;BA.debugLine="bc.FillGradient(Array As Int(0x00FFFFFF, GlobalVa";
mostCurrent._bc._fillgradient(new int[]{((int)0x00ffffff),(int) (mostCurrent._globalvariables._pricolor3 /*double*/ )},mostCurrent._bc._targetrect,"TOP_BOTTOM");
 //BA.debugLineNum = 153;BA.debugLine="FadeBitmap = bc.Bitmap";
mostCurrent._fadebitmap = mostCurrent._bc._getbitmap();
 //BA.debugLineNum = 154;BA.debugLine="MainMenu.SetIcon1(LoadBitmap(File.DirAssets, \"exp";
mostCurrent._mainmenu._seticon1 /*String*/ ((anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"explore.png").getObject())));
 //BA.debugLineNum = 155;BA.debugLine="MainMenu.SetIcon2(LoadBitmap(File.DirAssets, \"ser";
mostCurrent._mainmenu._seticon2 /*String*/ ((anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"services.png").getObject())));
 //BA.debugLineNum = 156;BA.debugLine="MainMenu.SetIcon5(LoadBitmap(File.DirAssets, \"bra";
mostCurrent._mainmenu._seticon5 /*String*/ ((anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"branches.png").getObject())));
 //BA.debugLineNum = 157;BA.debugLine="MainMenu.SetIcon3(LoadBitmap(File.DirAssets, \"cal";
mostCurrent._mainmenu._seticon3 /*String*/ ((anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"callus.png").getObject())));
 //BA.debugLineNum = 158;BA.debugLine="MainMenu.SetIcon4(LoadBitmap(File.DirAssets, \"use";
mostCurrent._mainmenu._seticon4 /*String*/ ((anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"user.png").getObject())));
 //BA.debugLineNum = 160;BA.debugLine="MainMenu.SetText1(\"Explore\")";
mostCurrent._mainmenu._settext1 /*String*/ ("Explore");
 //BA.debugLineNum = 161;BA.debugLine="MainMenu.SetText2(\"Services\")";
mostCurrent._mainmenu._settext2 /*String*/ ("Services");
 //BA.debugLineNum = 162;BA.debugLine="MainMenu.SetText5(\"Branches\")";
mostCurrent._mainmenu._settext5 /*String*/ ("Branches");
 //BA.debugLineNum = 163;BA.debugLine="MainMenu.SetText3(\"Contact Us\")";
mostCurrent._mainmenu._settext3 /*String*/ ("Contact Us");
 //BA.debugLineNum = 164;BA.debugLine="MainMenu.SetText4(\"Account\")";
mostCurrent._mainmenu._settext4 /*String*/ ("Account");
 //BA.debugLineNum = 166;BA.debugLine="cdTxtBox.Initialize2(Colors.Transparent, 0,0, Col";
...
public static String  _activity_permissionresult(String _permission,boolean _result) throws Exception{
 //BA.debugLineNum = 185;BA.debugLine="Sub Activity_PermissionResult (Permission As Strin";
 //BA.debugLineNum = 186;BA.debugLine="If Permission = GlobalVariables.RTP.PERMISSION_CA";
if ((_permission).equals(mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_CAMERA)) { 
 //BA.debugLineNum = 187;BA.debugLine="Result = True";
_result = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 188;BA.debugLine="LogColor(\"YOU CAN USE THE CAMERA\",Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("5327683","YOU CAN USE THE CAMERA",anywheresoftware.b4a.keywords.Common.Colors.Red);
 }else {
...
anywheresoftware.b4a.keywords.Common.LogImpl("5327687",_permission,0);
 //BA.debugLineNum = 193;BA.debugLine="End Sub";
return "";
}
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 170;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 173;BA.debugLine="scvMain.Visible = True";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 174;BA.debugLine="MainMenu_Page1Click";
_mainmenu_page1click();
 //BA.debugLineNum = 175;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 176;BA.debugLine="scvMain.ScrollPosition = 0";
mostCurrent._scvmain.setScrollPosition((int) (0));
 //BA.debugLineNum = 177;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 178;BA.debugLine="pnlServices.Visible = False";
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _cdw1 = null;
 //BA.debugLineNum = 724;BA.debugLine="Sub BackgroundAndCornerRadius(View As View , Corne";
 //BA.debugLineNum = 725;BA.debugLine="Dim cdw1 As ColorDrawable";
_cdw1 = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 726;BA.debugLine="cdw1.Initialize(Colors.White, CornerRadius)";
_cdw1.Initialize(anywheresoftware.b4a.keywords.Common.Colors.White,_cornerradius);
 //BA.debugLineNum = 727;BA.debugLine="View.Background = cdw1";
...
int _index = 0;
 //BA.debugLineNum = 410;BA.debugLine="Private Sub BBListItem1_LinkClicked (URL As String";
 //BA.debugLineNum = 411;BA.debugLine="Log(URL)";
anywheresoftware.b4a.keywords.Common.LogImpl("51638401",_url,0);
 //BA.debugLineNum = 412;BA.debugLine="Dim bb As BBListItem = Sender";
_bb = (com.bwsi.cares.bblistitem)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA));
 //BA.debugLineNum = 413;BA.debugLine="Dim index As Int = clvServices.GetItemFromView(bb";
_index = mostCurrent._clvservices._getitemfromview(_bb._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
 //BA.debugLineNum = 414;BA.debugLine="Log(index)";
anywheresoftware.b4a.keywords.Common.LogImpl("51638404",BA.NumberToString(_index),0);
 //BA.debugLineNum = 415;BA.debugLine="End Sub";
return "";
}
public static String  _btnlogin_click() throws Exception{
 //BA.debugLineNum = 785;BA.debugLine="Private Sub btnLogin_Click";
 //BA.debugLineNum = 787;BA.debugLine="End Sub";
return "";
}
public static String  _btnreg_click() throws Exception{
 //BA.debugLineNum = 790;BA.debugLine="Private Sub btnReg_Click";
 //BA.debugLineNum = 792;BA.debugLine="End Sub";
return "";
}
public static String  _btnregister_click() throws Exception{
 //BA.debugLineNum = 778;BA.debugLine="Private Sub btnRegister_Click";
 //BA.debugLineNum = 779;BA.debugLine="pnlLogin.Visible = False";
mostCurrent._pnllogin.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 780;BA.debugLine="pnlRegister.Visible = True";
mostCurrent._pnlregister.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 781;BA.debugLine="btnReg.Visible = True";
mostCurrent._btnreg.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 782;BA.debugLine="btnLogin.Visible = False";
...
public static String  _btnservicesback_click() throws Exception{
 //BA.debugLineNum = 533;BA.debugLine="Private Sub btnServicesBack_Click";
 //BA.debugLineNum = 534;BA.debugLine="MainMenu_Page1Click";
_mainmenu_page1click();
...
int _y = 0;
int _x = 0;
 //BA.debugLineNum = 693;BA.debugLine="Sub ChangeColorBasedOnAlphaLevel(bmp As B4XBitmap,";
 //BA.debugLineNum = 694;BA.debugLine="Dim bc As BitmapCreator";
mostCurrent._bc = new b4a.example.bitmapcreator();
 //BA.debugLineNum = 695;BA.debugLine="bc.Initialize(bmp.Width, bmp.Height)";
mostCurrent._bc._initialize(processBA,(int) (_bmp.getWidth()),(int) (_bmp.getHeight()));
 //BA.debugLineNum = 696;BA.debugLine="bc.CopyPixelsFromBitmap(bmp)";
mostCurrent._bc._copypixelsfrombitmap(_bmp);
 //BA.debugLineNum = 697;BA.debugLine="Dim a1, a2 As ARGBColor";
_a1 = new b4a.example.bitmapcreator._argbcolor();
_a2 = new b4a.example.bitmapcreator._argbcolor();
 //BA.debugLineNum = 698;BA.debugLine="bc.ColorToARGB(NewColor, a1)";
mostCurrent._bc._colortoargb(_newcolor,_a1);
 //BA.debugLineNum = 699;BA.debugLine="For y = 0 To bc.mHeight - 1";
{
final int step6 = 1;
final int limit6 = (int) (mostCurrent._bc._mheight-1);
_y = (int) (0) ;
for (;_y <= limit6 ;_y = _y + step6 ) {
 //BA.debugLineNum = 700;BA.debugLine="For x = 0 To bc.mWidth - 1";
{
final int step7 = 1;
final int limit7 = (int) (mostCurrent._bc._mwidth-1);
_x = (int) (0) ;
for (;_x <= limit7 ;_x = _x + step7 ) {
 //BA.debugLineNum = 701;BA.debugLine="bc.GetARGB(x, y, a2)";
mostCurrent._bc._getargb(_x,_y,_a2);
 //BA.debugLineNum = 702;BA.debugLine="If a2.a > 0 Then";
if (_a2.a>0) { 
 //BA.debugLineNum = 703;BA.debugLine="a2.r = a1.r";
_a2.r = _a1.r;
 //BA.debugLineNum = 704;BA.debugLine="a2.g = a1.g";
_a2.g = _a1.g;
 //BA.debugLineNum = 705;BA.debugLine="a2.b = a1.b";
_a2.b = _a1.b;
 //BA.debugLineNum = 706;BA.debugLine="bc.SetARGB(x, y, a2)";
mostCurrent._bc._setargb(_x,_y,_a2);
 ...
 //BA.debugLineNum = 710;BA.debugLine="Return bc.Bitmap";
...
//C
this.state = 1;
 //BA.debugLineNum = 228;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 230;BA.debugLine="Wait For (p.ShellAsync(\"ping\", Array As String(\"-";
...
;
 //BA.debugLineNum = 231;BA.debugLine="If StdErr = \"\" And StdOut.Contains(\"Destination H";
if (true) break;
...
public static String  _checkpermissions() throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Private Sub CheckPermissions";
 //BA.debugLineNum = 213;BA.debugLine="Log(\"Checking Permissions\")";
anywheresoftware.b4a.keywords.Common.LogImpl("5589825","Checking Permissions",0);
 //BA.debugLineNum = 215;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_READ_EXTERNAL_STORAGE);
 //BA.debugLineNum = 216;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_WRITE_EXTERNAL_STORAGE);
 //BA.debugLineNum = 217;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_ACCESS_COARSE_LOCATION);
 //BA.debugLineNum = 218;BA.debugLine="GlobalVariables.RTP.GetAllSafeDirsExternal(\"\")";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .GetAllSafeDirsExternal("");
 //BA.debugLineNum = 220;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_CAMERA);
 //BA.debugLineNum = 221;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
...
Object[] _v = null;
 //BA.debugLineNum = 288;BA.debugLine="Private Sub clvNews_ItemClick (Index As Int, Value";
 //BA.debugLineNum = 289;BA.debugLine="Dim v() As Object = Value";
_v = (Object[])(_value);
 //BA.debugLineNum = 290;BA.debugLine="Dim Index As Int = v(0)";
_index = (int)(BA.ObjectToNumber(_v[(int) (0)]));
 //BA.debugLineNum = 291;BA.debugLine="SelectedNews = v(1)";
_selectednews = (com.bwsi.cares.main._mynews)(_v[(int) (1)]);
 //BA.debugLineNum = 292;BA.debugLine="StartActivity(NewsPage)";
...
com.bwsi.cares.bblistitem _bb = null;
 //BA.debugLineNum = 417;BA.debugLine="Private Sub clvServices_ScrollChanged (Offset As I";
 //BA.debugLineNum = 418;BA.debugLine="For i = 0 To clvServices.Size - 1";
{
final int step1 = 1;
final int limit1 = (int) (mostCurrent._clvservices._getsize()-1);
_i = (int) (0) ;
for (;_i <= limit1 ;_i = _i + step1 ) {
 //BA.debugLineNum = 419;BA.debugLine="Dim pnl As B4XView = clvServices.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvservices._getpanel(_i);
 //BA.debugLineNum = 420;BA.debugLine="If pnl.NumberOfViews = 0 Then Return";
if (_pnl.getNumberOfViews()==0) { 
if (true) return "";};
 //BA.debugLineNum = 421;BA.debugLine="Dim BB As BBListItem = pnl.GetView(1).GetView(BB";
_bb = (com.bwsi.cares.bblistitem)(_pnl.GetView((int) (1)).GetView(_bblistitemindexinitems).getTag());
 //BA.debugLineNum = 422;BA.debugLine="BB.ParentScrolled(Offset, clvServices.GetRawList";
...
public static String  _clvservices_visiblerangechanged(int _firstindex,int _lastindex) throws Exception{
 //BA.debugLineNum = 441;BA.debugLine="Private Sub clvServices_VisibleRangeChanged (First";
...
com.bwsi.cares.main._mynews _info = null;
 //BA.debugLineNum = 264;BA.debugLine="Sub CreateItem()";
 //BA.debugLineNum = 265;BA.debugLine="For i = 0 To 3";
{
final int step1 = 1;
...
_p = mostCurrent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 267;BA.debugLine="Dim height As Int = 100%y";
_height = anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA);
 //BA.debugLineNum = 268;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 100%x , height)";
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_height);
 //BA.debugLineNum = 269;BA.debugLine="p.LoadLayout(\"NewsCards\")";
_p.LoadLayout("NewsCards",mostCurrent.activityBA);
 //BA.debugLineNum = 270;BA.debugLine="Dim Info As MyNews";
_info = new com.bwsi.cares.main._mynews();
 //BA.debugLineNum = 272;BA.debugLine="imgNews.Bitmap = bitmp(i)";
...
int _i = 0;
 //BA.debugLineNum = 400;BA.debugLine="Private Sub CreateItemText(index As Int) As String";
 //BA.debugLineNum = 401;BA.debugLine="Dim sb As StringBuilder";
_sb = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 402;BA.debugLine="sb.Initialize";
_sb.Initialize();
 //BA.debugLineNum = 403;BA.debugLine="sb.Append($\"[alignment=center][b]Item #${index}[/";
_sb.Append(("[alignment=center][b]Item #"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_index))+"[/b][/alignment]"));
 //BA.debugLineNum = 404;BA.debugLine="For i = 1 To Rnd(1, 20)";
{
final int step4 = 1;
final int limit4 = anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (20));
_i = (int) (1) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 405;BA.debugLine="sb.Append(CRLF).Append($\"[u]Line ${i}[/u]: [colo";
_sb.Append(anywheresoftware.b4a.keywords.Common.CRLF).Append(("[u]Line "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_i))+"[/u]: [color=red]alksd[/color] [url=\"https://www.b4x.com\"]jalksd jklasd[/url] kalsd "));
 ...
 //BA.debugLineNum = 407;BA.debugLine="Return sb.ToString";
if (true) return _sb.ToString();
 //BA.debugLineNum = 408;BA.debugLine="End Sub";
return "";
}
public static String  _dosomething_tick() throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Private Sub DoSomething_Tick";
 //BA.debugLineNum = 198;BA.debugLine="Log(\"WORKING...\")";
anywheresoftware.b4a.keywords.Common.LogImpl("5393217","WORKING...",0);
 //BA.debugLineNum = 199;BA.debugLine="End Sub";
return "";
}
public static String  _fabapply_click() throws Exception{
 //BA.debugLineNum = 348;BA.debugLine="Private Sub fabApply_Click";
 //BA.debugLineNum = 349;BA.debugLine="StartActivity(DataPrivacyPage)";
...
String _content = "";
 //BA.debugLineNum = 537;BA.debugLine="Private Sub GetContent(iServiceID As Int) As Strin";
 //BA.debugLineNum = 538;BA.debugLine="Private Content As String";
_content = "";
 //BA.debugLineNum = 540;BA.debugLine="Select iServiceID";
switch (_iserviceid) {
case 1: {
 //BA.debugLineNum = 542;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Sourcing o";
_content = ("[TextSize=14][INDENT=1]Sourcing of underground water reservoirs, also [/INDENT][alignment=justify]known as [b]groundwater sourcing or groundwater exploration[/b], refers to the process of locating and accessing underground water supplies or aquifers for various purposes, such as drinking water supply, irrigation, industrial use, or environmental restoration. This is an essential activity in regions where surface water sources may be insufficient or unreliable.\n"+"Here are the general steps involved in the sourcing of underground water reservoirs:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Site Assessment\n"+"[*]Geophysical Surveys\n"+"[*]Exploratory Drilling\n"+"[*]Aquifer Testing\n"+"[*]Water Quality Analysis\n"+"[*]Well Design and Construction\n"+"[*]Pumping and Monitoring\n"+"[*]Regulatory Compliance\n"+"[*]Maintenance and Rehabilitation\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 2: {
 //BA.debugLineNum = 557;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]The instal";
_content = ("[TextSize=14][INDENT=1]The installation of pumps and motors[/INDENT][alignment=justify] is a common process in various applications, including water supply systems, industrial processes, agricultural irrigation, and more. Proper installation is crucial to ensure the efficient and safe operation of these components.\n"+"Here are the general steps involved in the installation of pumps and motors:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Site Preparation\n"+"[*]Foundation Construction\n"+"[*]Electrical Wiring\n"+"[*]Alignment\n"+"[*]Coupling Installation (if applicable\n"+"[*]Piping and Plumbing\n"+"[*]Prime the Pump (if applicable\n"+"[*]Motor Alignment and Coupling Tightening (if applicable\n"+"[*]Start-Up and Testing\n"+"[*]Safety Measures\n"+"[*]Documentation\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 3: {
 //BA.debugLineNum = 574;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Laying mai";
_content = ("[TextSize=14][INDENT=1]Laying mainline distribution pipes is a [/INDENT][alignment=justify]crucial step in establishing a water distribution system for supplying water to homes, businesses, and other end-users. This process involves the installation of large-diameter pipes that serve as the primary conveyance system for transporting water from the source (such as a treatment plant or well) to various distribution points.\n"+"Here are the key steps involved in laying mainline distribution pipes:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Design and Planning\n"+"[*]Materials and Equipment Preparation\n"+"[*]Route Survey and Marking\n"+"[*]Excavation and Trenching\n"+"[*]Bedding and Backfill\n"+"[*]Pipe Installation\n"+"[*]Pressure Testing\n"+"[*]Disinfection and Flushing\n"+"[*]Connection to Source and Distribution Points\n"+"[*]Testing and Commissioning\n"+"[*]Documentation and Record Keeping\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 4: {
 //BA.debugLineNum = 591;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Chlorinati";
_content = ("[TextSize=14][INDENT=1]Chlorination of water sources is a [/INDENT][alignment=justify]common and effective method of disinfecting water to make it safe for consumption and other uses. Chlorine is added to water to kill or inactivate harmful microorganisms, such as bacteria, viruses, and parasites, that may be present in the water. Chlorination is widely used in public water supply systems, industrial processes, and swimming pools, among other applications.\n"+"Here's an overview of the chlorination process for water sources:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Selection of Chlorine Compound\n"+"[*]Dosage Determination\n"+"[*]Chlorine Addition\n"+"[*]Contact Time\n"+"[*]Residual Chlorine Monitoring\n"+"[*]Adjustment of Ph\n"+"[*]Dechlorination (if required\n"+"[*]Sampling and Testing\n"+"[*]Safety Precautions\n"+"[*]Documentation\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 5: {
 //BA.debugLineNum = 607;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Filtration";
_content = ("[TextSize=14][INDENT=1]Filtration of surface water sources is a [/INDENT][alignment=justify]critical step in the treatment of water to make it safe for consumption and other uses. Surface water sources, such as rivers, lakes, and reservoirs, often contain suspended particles, sediments, algae, bacteria, and other impurities that need to be removed. Filtration is an essential part of the water treatment process and helps improve the water's clarity, taste, and safety.\n"+"Here's an overview of the filtration process for surface water sources:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Coagulation and Flocculation\n"+"[*]Screening (Optional\n"+"[*]Filtration Media Selection\n"+"[*]Filter Bed Preparation\n"+"[*]Filtration Process\n"+"[*]Backwashing (Cleaning)\n"+"[*]Disinfection (Optional)\n"+"[*]Post-Filtration Treatment (if needed)\n"+"[*]Quality Monitoring\n"+"[*]Distribution\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 6: {
 //BA.debugLineNum = 623;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Connecting";
_content = ("[TextSize=14][INDENT=1]Connecting households and businesses to [/INDENT][alignment=justify]mainlines, often referred to as water or utility mains, is a crucial step in providing these consumers with access to essential services like water supply, natural gas, electricity, or telecommunications. The process of connecting properties to mainlines varies depending on the type of utility being provided and local regulations.\n"+"Here is a general overview of the steps involved in connecting households and businesses to mainlines:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Application and Permits\n"+"[*]Utility Assessment and Planning\n"+"[*]Design and Engineering\n"+"[*]Construction and Installation\n"+"[*]Connection to Property\n"+"[*]Inspection and Testing\n"+"[*]Connection Activation\n"+"[*]Billing and Service Agreements\n"+"[*]Ongoing Maintenance and Service\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 7: {
 //BA.debugLineNum = 638;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Meter read";
_content = ("[TextSize=14][INDENT=1]Meter reading, billing, and payment collection are[/INDENT][alignment=justify] crucial components of utility services, such as electricity, water, gas, and telecommunications. These processes ensure that consumers are accurately billed for the services they use and enable utility providers to maintain their infrastructure and operations.\n"+"Here's an overview of each of these processes:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Meter Reading\n"+"[*]Billing\n"+"[*]Payment Collection\n"+"[*]Customer Support and Dispute Resolution\n"+"[*]Meter Maintenance and Replacement\n"+"[*]Data Security and Privacy\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 8: {
 //BA.debugLineNum = 650;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]After-sale";
_content = ("[TextSize=14][INDENT=1]After-sales services for utilities, including repairs [/INDENT][alignment=justify]of leaks and broken meters, are essential for maintaining the reliability and functionality of utility services and ensuring customer satisfaction. \n"+"Here's an overview of the after-sales services related to utility repairs:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Customer Reporting\n"+"[*]Issue Assessment\n"+"[*]Dispatching Technicians\n"+"[*]Meter Replacement or Repair\n"+"[*]Leak Repair\n"+"[*]Emergency Response\n"+"[*]Safety Measures\n"+"[*]Communication with Customers\n"+"[*]Quality Assurance\n"+"[*]Testing and Verification\n"+"[*]Billing Adjustments\n"+"[*]Customer Feedback\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 9: {
 //BA.debugLineNum = 668;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Reducing n";
...
;
 //BA.debugLineNum = 687;BA.debugLine="Return Content";
...
mostCurrent._mainmenu = new com.bwsi.cares.asbottommenu();
 //BA.debugLineNum = 86;BA.debugLine="Private btnLogin As Panel";
mostCurrent._btnlogin = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 87;BA.debugLine="Private btnReg As Panel";
mostCurrent._btnreg = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 88;BA.debugLine="Private btnRegister As Label";
mostCurrent._btnregister = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 89;BA.debugLine="Private pnlRegister As Panel";
mostCurrent._pnlregister = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 90;BA.debugLine="Private REGbtnRegister As Label";
mostCurrent._regbtnregister = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 91;BA.debugLine="Private txtRegConfirmPassword As EditText";
mostCurrent._txtregconfirmpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 92;BA.debugLine="Private txtRegEmail As EditText";
mostCurrent._txtregemail = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 93;BA.debugLine="Private txtRegFullName As EditText";
mostCurrent._txtregfullname = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 94;BA.debugLine="Private txtRegPassword As EditText";
mostCurrent._txtregpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 95;BA.debugLine="Private REGlblLogin As Label";
mostCurrent._reglbllogin = new anywheresoftware.b4a.objects.LabelWrapper();
...
//C
this.state = -1;
 //BA.debugLineNum = 241;BA.debugLine="Return mXUI.LoadBitmapResize(File.DirAssets,$\"web";
if (true) {
...
public static String  _initializedatas() throws Exception{
 //BA.debugLineNum = 295;BA.debugLine="Sub InitializeDatas";
 //BA.debugLineNum = 296;BA.debugLine="bitmp(0) = LoadBitmap(File.DirAssets,\"News1.jpg\")";
mostCurrent._bitmp[(int) (0)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News1.jpg");
 //BA.debugLineNum = 297;BA.debugLine="bitmp(1) = LoadBitmap(File.DirAssets,\"News2.jpg\")";
mostCurrent._bitmp[(int) (1)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News2.jpg");
 //BA.debugLineNum = 298;BA.debugLine="bitmp(2) = LoadBitmap(File.DirAssets,\"News6.jpg\")";
mostCurrent._bitmp[(int) (2)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News6.jpg");
 //BA.debugLineNum = 299;BA.debugLine="bitmp(3) = LoadBitmap(File.DirAssets,\"News4.png\")";
mostCurrent._bitmp[(int) (3)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News4.png");
 //BA.debugLineNum = 301;BA.debugLine="strNewsTitle(0) = \"Happy 65th anniversary, BWSI\"";
mostCurrent._strnewstitle[(int) (0)] = "Happy 65th anniversary, BWSI";
 //BA.debugLineNum = 302;BA.debugLine="strAuthor(0) = Chr(0xF044) & \" Balibago Waterwork";
mostCurrent._strauthor[(int) (0)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf044)))+" Balibago Waterworks";
 //BA.debugLineNum = 303;BA.debugLine="strDate(0) = Chr(0xF073) & \" 2023-05-21\"";
mostCurrent._strdate[(int) (0)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf073)))+" 2023-05-21";
 //BA.debugLineNum = 304;BA.debugLine="strNewsDesc(0) = _ $\"[Alignment=justify][TextSize";
mostCurrent._strnewsdesc[(int) (0)] = ("[Alignment=justify][TextSize=15]From humble beginnings To a beacon of progress, we have been making waves in providing clean, healthy, And potable water services To almost two million people now. Let us honor our legacy And embrace the winds of change, ensuring a brighter, greener, And sustainable future For generations To come.\n"+"[b]Happy 65th Anniversary, BWSI![/b][/TextSize][/Alignment]");
 //BA.debugLineNum = 308;BA.debugLine="strNewsTitle(1) = \"World Water Day 2023!\"";
mostCurrent._strnewstitle[(int) (1)] = "World Water Day 2023!";
 //BA.debugLineNum = 309;BA.debugLine="strAuthor(1) = Chr(0xF044) & \" Balibago Waterwork";
mostCurrent._strauthor[(int) (1)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf044)))+" Balibago Waterworks";
 //BA.debugLineNum = 310;BA.debugLine="strDate(1) = Chr(0xF073) & \" 2023-01-12\"";
mostCurrent._strdate[(int) (1)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf073)))+" 2023-01-12";
 //BA.debugLineNum = 311;BA.debugLine="strNewsDesc(1) = _ $\"[Alignment=justify][TextSize";
...
//C
this.state = 1;
 //BA.debugLineNum = 446;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 447;BA.debugLine="clvServices.Clear";
...
this.state = 4;
this.catchState = 21;
 //BA.debugLineNum = 449;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblServices";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblServices "+"ORDER BY id ASC";
 //BA.debugLineNum = 452;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 453;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
;
 //BA.debugLineNum = 455;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 456;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 457;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 10;
 //BA.debugLineNum = 458;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent.mostCurrent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 459;BA.debugLine="Pnl.SetLayoutAnimated(0, 0, 0, clvServices.AsV";
...
_ex.ExpandedHeight /*int*/  = (int) (anywheresoftware.b4a.keywords.Common.Max(_ex.CollapsedHeight /*int*/ ,_bb._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))+_titlepnl.getHeight()));
 //BA.debugLineNum = 472;BA.debugLine="Dim fade As B4XView = Pnl.GetView(1).GetView(1";
_fade = new anywheresoftware.b4a.objects.B4XViewWrapper();
_fade = _pnl.GetView((int) (1)).GetView((int) (1));
 //BA.debugLineNum = 473;BA.debugLine="Dim Arrow As B4XView = Pnl.GetView(0).GetView(";
_arrow = new anywheresoftware.b4a.objects.B4XViewWrapper();
_arrow = _pnl.GetView((int) (0)).GetView((int) (2));
 //BA.debugLineNum = 476;BA.debugLine="If ex.ExpandedHeight > ex.CollapsedHeight Then";
if (true) break;
...
//C
this.state = 15;
 //BA.debugLineNum = 477;BA.debugLine="Arrow.Visible = True";
_arrow.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 478;BA.debugLine="fade.Visible = True";
_fade.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 480;BA.debugLine="fade.Top = ex.CollapsedHeight - fade.Height -";
_fade.setTop((int) (_ex.CollapsedHeight /*int*/ -_fade.getHeight()-_titlepnl.getHeight()));
 //BA.debugLineNum = 481;BA.debugLine="bc.SetBitmapToImageView(FadeBitmap, fade)";
...
//C
this.state = 15;
 //BA.debugLineNum = 483;BA.debugLine="Arrow.Visible = False";
_arrow.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 484;BA.debugLine="fade.Visible = False";
...
this.state = 7;
;
 //BA.debugLineNum = 486;BA.debugLine="Pnl.SetLayoutAnimated(0, 0, 0, Pnl.Width, ex.C";
_pnl.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_pnl.getWidth(),_ex.CollapsedHeight /*int*/ );
 //BA.debugLineNum = 487;BA.debugLine="clvServices.Add(Pnl, ex)";
...
anywheresoftware.b4a.keywords.Common.LogImpl("51900595",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 //BA.debugLineNum = 529;BA.debugLine="clvServices_ScrollChanged(0)";
...
public static String  _inittxtboxes() throws Exception{
 //BA.debugLineNum = 384;BA.debugLine="Private Sub InitTxtBoxes";
 //BA.debugLineNum = 385;BA.debugLine="txtLoginEMail.Background = cdTxtBox";
mostCurrent._txtloginemail.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 386;BA.debugLine="txtLoginPassword.Background = cdTxtBox";
mostCurrent._txtloginpassword.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 387;BA.debugLine="txtRegEmail.Background = cdTxtBox";
mostCurrent._txtregemail.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 388;BA.debugLine="txtRegFullName.Background = cdTxtBox";
mostCurrent._txtregfullname.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 389;BA.debugLine="txtRegPassword.Background = cdTxtBox";
mostCurrent._txtregpassword.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 390;BA.debugLine="txtRegConfirmPassword.Background = cdTxtBox";
mostCurrent._txtregconfirmpassword.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 391;BA.debugLine="End Sub";
return "";
}
public static String  _lblviewall_click() throws Exception{
 //BA.debugLineNum = 767;BA.debugLine="Private Sub lblViewAll_Click";
 //BA.debugLineNum = 768;BA.debugLine="StartActivity(FAQsPage)";
...
public static String  _mainmenu_page1click() throws Exception{
 //BA.debugLineNum = 351;BA.debugLine="Private Sub MainMenu_Page1Click";
 //BA.debugLineNum = 352;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 353;BA.debugLine="pnlServices.Visible = False";
mostCurrent._pnlservices.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 354;BA.debugLine="scvMain.Visible = True";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 355;BA.debugLine="fabApply.Visible = True";
...
public static String  _mainmenu_page2click() throws Exception{
 //BA.debugLineNum = 358;BA.debugLine="Private Sub MainMenu_Page2Click";
 //BA.debugLineNum = 359;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 360;BA.debugLine="pnlServices.Visible = True";
mostCurrent._pnlservices.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 361;BA.debugLine="InitServices";
_initservices();
 //BA.debugLineNum = 362;BA.debugLine="scvMain.Visible = False";
...
public static String  _mainmenu_page3click() throws Exception{
 //BA.debugLineNum = 365;BA.debugLine="Private Sub MainMenu_Page3Click";
 //BA.debugLineNum = 367;BA.debugLine="End Sub";
return "";
}
public static String  _mainmenu_page4click() throws Exception{
 //BA.debugLineNum = 369;BA.debugLine="Private Sub MainMenu_Page4Click";
 //BA.debugLineNum = 370;BA.debugLine="scvMain.Visible = False";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 371;BA.debugLine="pnlServices.Visible = False";
mostCurrent._pnlservices.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 372;BA.debugLine="pnlAccount.Visible = True";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 373;BA.debugLine="pnlAccount.SetLayoutAnimated(0,0,0,100%x, 90%y)";
mostCurrent._pnlaccount.SetLayoutAnimated((int) (0),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 374;BA.debugLine="pnlAccount.LoadLayout(\"Login\")";
mostCurrent._pnlaccount.LoadLayout("Login",mostCurrent.activityBA);
 //BA.debugLineNum = 375;BA.debugLine="pnlLogin.Visible = True";
mostCurrent._pnllogin.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 376;BA.debugLine="btnLogin.Visible = True";
mostCurrent._btnlogin.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 377;BA.debugLine="pnlRegister.Visible = False";
mostCurrent._pnlregister.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 378;BA.debugLine="btnReg.Visible = False";
mostCurrent._btnreg.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 379;BA.debugLine="fabApply.Visible = False";
mostCurrent._fabapply.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 380;BA.debugLine="InitTxtBoxes";
_inittxtboxes();
 //BA.debugLineNum = 381;BA.debugLine="End Sub";
return "";
}
public static String  _mainmenu_page5click() throws Exception{
 //BA.debugLineNum = 394;BA.debugLine="Private Sub MainMenu_Page5Click";
...
int _left = 0;
 //BA.debugLineNum = 748;BA.debugLine="Sub Panel_Selection_Attr(Selection As ImageView)";
 //BA.debugLineNum = 751;BA.debugLine="Select Selection";
switch (BA.switchObjectToInt(_selection)) {
}
;
 //BA.debugLineNum = 755;BA.debugLine="BackgroundAndCornerRadius(PanelSelection,15dip)";
_backgroundandcornerradius((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._panelselection.getObject())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15)));
 //BA.debugLineNum = 756;BA.debugLine="PanelSelection.Color = GlobalVariables.PriColor1";
mostCurrent._panelselection.setColor((int) (mostCurrent._globalvariables._pricolor1 /*double*/ ));
 //BA.debugLineNum = 757;BA.debugLine="Dim Left As Int";
_left = 0;
 //BA.debugLineNum = 758;BA.debugLine="Left = Selection.Left - 5%x";
_left = (int) (_selection.getLeft()-anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 759;BA.debugLine="Activity.AddView(PanelSelection,Left,91%y,16%x,8%";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._panelselection.getObject()),_left,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (91),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (16),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 762;BA.debugLine="PanelSelection.SendToBack";
mostCurrent._panelselection.SendToBack();
 //BA.debugLineNum = 763;BA.debugLine="Activity.Color = 0xFFF3FDFF";
...
public static String  _pnlaboutus_click() throws Exception{
 //BA.debugLineNum = 255;BA.debugLine="Private Sub pnlAboutUs_Click";
 //BA.debugLineNum = 256;BA.debugLine="timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 257;BA.debugLine="StartActivity(HistoryPage)";
...
com.bwsi.cares.clvexpandable._expandableitemdata _e = null;
 //BA.debugLineNum = 427;BA.debugLine="Private Sub pnlServiceTitle_Click";
 //BA.debugLineNum = 431;BA.debugLine="Dim index As Int = clvServices.GetItemFromView(Se";
_index = mostCurrent._clvservices._getitemfromview((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA))));
 //BA.debugLineNum = 432;BA.debugLine="Dim Fade As B4XView = clvServices.GetPanel(index)";
_fade = new anywheresoftware.b4a.objects.B4XViewWrapper();
_fade = mostCurrent._clvservices._getpanel(_index).GetView((int) (1)).GetView((int) (1));
 //BA.debugLineNum = 433;BA.debugLine="Dim e As ExpandableItemData = Expandable.ToggleIt";
_e = mostCurrent._expandable._toggleitem /*com.bwsi.cares.clvexpandable._expandableitemdata*/ (_index);
 //BA.debugLineNum = 434;BA.debugLine="If e.ExpandedHeight <> e.CollapsedHeight Then";
if (_e.ExpandedHeight /*int*/ !=_e.CollapsedHeight /*int*/ ) { 
 //BA.debugLineNum = 435;BA.debugLine="Fade.SetVisibleAnimated(100dip, Not(e.Expanded))";
_fade.SetVisibleAnimated(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),anywheresoftware.b4a.keywords.Common.Not(_e.Expanded /*boolean*/ ));
 ...
 //BA.debugLineNum = 437;BA.debugLine="clvServices_ScrollChanged(clvServices.sv.ScrollVi";
...
public static String  _pnlsplash_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Private Sub pnlSplash_Touch (Action As Int, X As F";
...
public static String  _reglbllogin_click() throws Exception{
 //BA.debugLineNum = 771;BA.debugLine="Private Sub REGlblLogin_Click";
 //BA.debugLineNum = 772;BA.debugLine="pnlLogin.Visible = True";
mostCurrent._pnllogin.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 773;BA.debugLine="pnlRegister.Visible = False";
mostCurrent._pnlregister.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 774;BA.debugLine="btnLogin.Visible = True";
mostCurrent._btnlogin.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 775;BA.debugLine="btnReg.Visible = False";
mostCurrent._btnreg.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 776;BA.debugLine="End Sub";
return "";
}
public static String  _scvmain_scrollchanged(int _position) throws Exception{
 //BA.debugLineNum = 250;BA.debugLine="Sub scvMain_ScrollChanged(Position As Int)";
...
anywheresoftware.b4a.objects.ImageViewWrapper _iv = null;
 //BA.debugLineNum = 713;BA.debugLine="Public Sub SetBitmapWithFitOrFill (vTargetView As";
 //BA.debugLineNum = 714;BA.debugLine="vTargetView.SetBitmap(bmp)";
_vtargetview.SetBitmap((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 718;BA.debugLine="Dim iv As ImageView = vTargetView";
...
_iv = (anywheresoftware.b4a.objects.ImageViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ImageViewWrapper(), (android.widget.ImageView)(_vtargetview.getObject()));
 //BA.debugLineNum = 719;BA.debugLine="iv.Gravity = Gravity.FILL";
...
anywheresoftware.b4j.object.JavaObject _jo2 = null;
 //BA.debugLineNum = 730;BA.debugLine="Sub SetStatusBarAndNavigationColor(clr As Int)";
 //BA.debugLineNum = 731;BA.debugLine="Try";
try { //BA.debugLineNum = 732;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 733;BA.debugLine="jo.InitializeContext";
_jo.InitializeContext(processBA);
 //BA.debugLineNum = 734;BA.debugLine="Dim window As JavaObject = jo.RunMethodJO(\"getWi";
_window = new anywheresoftware.b4j.object.JavaObject();
_window = _jo.RunMethodJO("getWindow",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 735;BA.debugLine="window.RunMethod(\"addFlags\", Array (0x80000000))";
_window.RunMethod("addFlags",new Object[]{(Object)(((int)0x80000000))});
 //BA.debugLineNum = 737;BA.debugLine="window.RunMethod(\"clearFlags\", Array (0x04000000";
_window.RunMethod("clearFlags",new Object[]{(Object)(((int)0x04000000))});
 //BA.debugLineNum = 738;BA.debugLine="window.RunMethod(\"setStatusBarColor\", Array(clr)";
_window.RunMethod("setStatusBarColor",new Object[]{(Object)(_clr)});
 //BA.debugLineNum = 739;BA.debugLine="Dim jo2 As JavaObject";
_jo2 = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 740;BA.debugLine="jo2.InitializeContext";
_jo2.InitializeContext(processBA);
 //BA.debugLineNum = 741;BA.debugLine="jo2.RunMethodJO(\"getWindow\", Null).RunMethod(\"se";
_jo2.RunMethodJO("getWindow",(Object[])(anywheresoftware.b4a.keywords.Common.Null)).RunMethod("setNavigationBarColor",new Object[]{(Object)(_clr)});
			...
			processBA.setLastException(e12); //BA.debugLineNum = 743;BA.debugLine="ToastMessageShow(\"Some error with your android v";
...
//C
this.state = -1;
 //BA.debugLineNum = 201;BA.debugLine="pnlSplash.Visible = True";
parent.mostCurrent._pnlsplash.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 202;BA.debugLine="Sleep(3000)";
...
this.state = -1;
;
 //BA.debugLineNum = 203;BA.debugLine="pnlSplash.Visible = False";
parent.mostCurrent._pnlsplash.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 204;BA.debugLine="tmrSplash.Enabled = False";
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 243;BA.debugLine="Private Sub Timer1_Tick";
 //BA.debugLineNum = 244;BA.debugLine="imgSlider.NextImage";
