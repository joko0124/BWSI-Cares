...
public anywheresoftware.b4a.objects.ImageViewWrapper _btnaccount = null;
public anywheresoftware.b4a.objects.ImageViewWrapper _btnbranches = null;
public anywheresoftware.b4a.objects.ImageViewWrapper _btncallus = null;
public anywheresoftware.b4a.objects.ImageViewWrapper _btnhome = null;
public anywheresoftware.b4a.objects.ImageViewWrapper _btnservices = null;
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 95;BA.debugLine="CheckPermissions";
_checkpermissions();
 //BA.debugLineNum = 96;BA.debugLine="Activity.LoadLayout(\"landingpage\")";
mostCurrent._activity.LoadLayout("landingpage",mostCurrent.activityBA);
 //BA.debugLineNum = 97;BA.debugLine="If FirstTime Then";
if (_firsttime) { 
 //BA.debugLineNum = 98;BA.debugLine="SetStatusBarAndNavigationColor(0x7CD4D4D4)";
_setstatusbarandnavigationcolor(((int)0x7cd4d4d4));
 //BA.debugLineNum = 99;BA.debugLine="ShowSplash";
_showsplash();
 };
 //BA.debugLineNum = 101;BA.debugLine="tmrSplash.Initialize(\"DoSomething\",300)";
_tmrsplash.Initialize(processBA,"DoSomething",(long) (300));
 //BA.debugLineNum = 102;BA.debugLine="tmrSplash.Enabled = True";
_tmrsplash.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 103;BA.debugLine="scvMain.Visible = True";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 104;BA.debugLine="scvMain.Panel.LoadLayout(\"LandingContents\")";
...
mostCurrent._scvmain.getPanel().setHeight(mostCurrent._pnlmain.getHeight());
 //BA.debugLineNum = 106;BA.debugLine="PanelSelection.Initialize(\"PanelSelection\")";
mostCurrent._panelselection.Initialize(mostCurrent.activityBA,"PanelSelection");
 //BA.debugLineNum = 107;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 113;BA.debugLine="imgSlider.NumberOfImages = 4";
mostCurrent._imgslider._setnumberofimages /*int*/ ((int) (4));
 //BA.debugLineNum = 114;BA.debugLine="imgSlider.PrevImage";
mostCurrent._imgslider._previmage /*void*/ ();
 //BA.debugLineNum = 115;BA.debugLine="timer1.Initialize(\"Timer1\",3000)";
_timer1.Initialize(processBA,"Timer1",(long) (3000));
 //BA.debugLineNum = 116;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 118;BA.debugLine="SetStatusBarAndNavigationColor(GlobalVariables.Pr";
_setstatusbarandnavigationcolor((int) (mostCurrent._globalvariables._pricolor1 /*double*/ ));
 //BA.debugLineNum = 120;BA.debugLine="Panel_Selection_Attr(btnHome)";
_panel_selection_attr(mostCurrent._btnhome);
 //BA.debugLineNum = 122;BA.debugLine="InitializeDatas";
_initializedatas();
 //BA.debugLineNum = 124;BA.debugLine="CreateItem";
_createitem();
 //BA.debugLineNum = 129;BA.debugLine="fabApply.IconDrawable = \"fab_add\"";
mostCurrent._fabapply.setIconDrawable("fab_add");
 //BA.debugLineNum = 130;BA.debugLine="fabApply.ColorNormal = GlobalVariables.PriColor2";
mostCurrent._fabapply.setColorNormal((int) (mostCurrent._globalvariables._pricolor2 /*double*/ ));
 //BA.debugLineNum = 131;BA.debugLine="fabApply.ColorPressed = GlobalVariables.PriColor3";
mostCurrent._fabapply.setColorPressed((int) (mostCurrent._globalvariables._pricolor3 /*double*/ ));
 //BA.debugLineNum = 132;BA.debugLine="fabApply.ColorRipple = GlobalVariables.PriColor1";
mostCurrent._fabapply.setColorRipple((int) (mostCurrent._globalvariables._pricolor1 /*double*/ ));
 //BA.debugLineNum = 133;BA.debugLine="fabApply.ButtonSize = 1";
mostCurrent._fabapply.setButtonSize((int) (1));
 //BA.debugLineNum = 137;BA.debugLine="fabApply.Indeterminate = True";
mostCurrent._fabapply.setIndeterminate(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 145;BA.debugLine="TextEngine.Initialize(Activity)";
mostCurrent._textengine._initialize /*String*/ (mostCurrent.activityBA,(anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(mostCurrent._activity.getObject())));
 //BA.debugLineNum = 146;BA.debugLine="Expandable.Initialize(clvServices)";
mostCurrent._expandable._initialize /*String*/ (mostCurrent.activityBA,mostCurrent._clvservices);
 //BA.debugLineNum = 147;BA.debugLine="bc.Initialize(Activity.Width, 40dip)";
mostCurrent._bc._initialize(processBA,mostCurrent._activity.getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40)));
 //BA.debugLineNum = 148;BA.debugLine="bc.FillGradient(Array As Int(0x00FFFFFF, GlobalVa";
mostCurrent._bc._fillgradient(new int[]{((int)0x00ffffff),(int) (mostCurrent._globalvariables._pricolor3 /*double*/ )},mostCurrent._bc._targetrect,"TOP_BOTTOM");
 //BA.debugLineNum = 149;BA.debugLine="FadeBitmap = bc.Bitmap";
...
public static String  _activity_permissionresult(String _permission,boolean _result) throws Exception{
 ...
 //BA.debugLineNum = 169;BA.debugLine="If Permission = GlobalVariables.RTP.PERMISSION_CA";
if ((_permission).equals(mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_CAMERA)) { 
 //BA.debugLineNum = 170;BA.debugLine="Result = True";
_result = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 171;BA.debugLine="LogColor(\"YOU CAN USE THE CAMERA\",Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("3327683","YOU CAN USE THE CAMERA",anywheresoftware.b4a.keywords.Common.Colors.Red);
 }else {
...
anywheresoftware.b4a.keywords.Common.LogImpl("3327687",_permission,0);
 //BA.debugLineNum = 176;BA.debugLine="End Sub";
return "";
}
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 153;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 156;BA.debugLine="scvMain.Visible = True";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 157;BA.debugLine="btnHome_Click";
_btnhome_click();
 //BA.debugLineNum = 158;BA.debugLine="timer1.Enabled = True";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 159;BA.debugLine="scvMain.ScrollPosition = 0";
mostCurrent._scvmain.setScrollPosition((int) (0));
 //BA.debugLineNum = 160;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 161;BA.debugLine="pnlServices.Visible = False";
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _cdw1 = null;
 //BA.debugLineNum = 704;BA.debugLine="Sub BackgroundAndCornerRadius(View As View , Corne";
 //BA.debugLineNum = 705;BA.debugLine="Dim cdw1 As ColorDrawable";
_cdw1 = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 706;BA.debugLine="cdw1.Initialize(Colors.White, CornerRadius)";
_cdw1.Initialize(anywheresoftware.b4a.keywords.Common.Colors.White,_cornerradius);
 //BA.debugLineNum = 707;BA.debugLine="View.Background = cdw1";
...
int _index = 0;
 //BA.debugLineNum = 391;BA.debugLine="Private Sub BBListItem1_LinkClicked (URL As String";
 //BA.debugLineNum = 392;BA.debugLine="Log(URL)";
anywheresoftware.b4a.keywords.Common.LogImpl("31638401",_url,0);
 //BA.debugLineNum = 393;BA.debugLine="Dim bb As BBListItem = Sender";
_bb = (com.bwsi.cares.bblistitem)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA));
 //BA.debugLineNum = 394;BA.debugLine="Dim index As Int = clvServices.GetItemFromView(bb";
_index = mostCurrent._clvservices._getitemfromview(_bb._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ );
 //BA.debugLineNum = 395;BA.debugLine="Log(index)";
anywheresoftware.b4a.keywords.Common.LogImpl("31638404",BA.NumberToString(_index),0);
 //BA.debugLineNum = 396;BA.debugLine="End Sub";
return "";
}
public static String  _btnaccount_click() throws Exception{
 //BA.debugLineNum = 365;BA.debugLine="Private Sub btnAccount_Click";
 //BA.debugLineNum = 366;BA.debugLine="PanelSelection.RemoveView";
mostCurrent._panelselection.RemoveView();
 //BA.debugLineNum = 367;BA.debugLine="Panel_Selection_Attr(btnAccount)";
_panel_selection_attr(mostCurrent._btnaccount);
 //BA.debugLineNum = 368;BA.debugLine="scvMain.Visible = False";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 369;BA.debugLine="pnlServices.Visible = False";
mostCurrent._pnlservices.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 370;BA.debugLine="pnlAccount.Visible = True";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 371;BA.debugLine="pnlAccount.SetLayoutAnimated(0,0,0,100%x, 90%y)";
mostCurrent._pnlaccount.SetLayoutAnimated((int) (0),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (90),mostCurrent.activityBA));
 //BA.debugLineNum = 372;BA.debugLine="pnlAccount.LoadLayout(\"Login\")";
mostCurrent._pnlaccount.LoadLayout("Login",mostCurrent.activityBA);
 //BA.debugLineNum = 373;BA.debugLine="cdTxtBox.Initialize2(Colors.Transparent, 0,0, Col";
mostCurrent._cdtxtbox.Initialize2(anywheresoftware.b4a.keywords.Common.Colors.Transparent,(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.Colors.Transparent);
 //BA.debugLineNum = 374;BA.debugLine="txtLoginEMail.Background = cdTxtBox";
mostCurrent._txtloginemail.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 375;BA.debugLine="txtLoginPassword.Background = cdTxtBox";
mostCurrent._txtloginpassword.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 376;BA.debugLine="fabApply.Visible = False";
mostCurrent._fabapply.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 377;BA.debugLine="End Sub";
return "";
}
public static String  _btnbranches_click() throws Exception{
 //BA.debugLineNum = 355;BA.debugLine="Private Sub btnBranches_Click";
 //BA.debugLineNum = 356;BA.debugLine="PanelSelection.RemoveView";
mostCurrent._panelselection.RemoveView();
 //BA.debugLineNum = 357;BA.debugLine="Panel_Selection_Attr(btnBranches)";
_panel_selection_attr(mostCurrent._btnbranches);
 //BA.debugLineNum = 358;BA.debugLine="End Sub";
return "";
}
public static String  _btncallus_click() throws Exception{
 //BA.debugLineNum = 360;BA.debugLine="Private Sub btnCallUs_Click";
 //BA.debugLineNum = 361;BA.debugLine="PanelSelection.RemoveView";
mostCurrent._panelselection.RemoveView();
 //BA.debugLineNum = 362;BA.debugLine="Panel_Selection_Attr(btnCallUs)";
_panel_selection_attr(mostCurrent._btncallus);
 //BA.debugLineNum = 363;BA.debugLine="End Sub";
return "";
}
public static String  _btnhome_click() throws Exception{
 //BA.debugLineNum = 334;BA.debugLine="Private Sub btnHome_Click";
 //BA.debugLineNum = 335;BA.debugLine="pnlAccount.Visible = False";
mostCurrent._pnlaccount.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 336;BA.debugLine="pnlServices.Visible = False";
mostCurrent._pnlservices.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 337;BA.debugLine="PanelSelection.RemoveView";
mostCurrent._panelselection.RemoveView();
 //BA.debugLineNum = 338;BA.debugLine="Panel_Selection_Attr(btnHome)";
_panel_selection_attr(mostCurrent._btnhome);
 //BA.debugLineNum = 339;BA.debugLine="scvMain.Visible = True";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 340;BA.debugLine="fabApply.Visible = True";
mostCurrent._fabapply.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 341;BA.debugLine="End Sub";
return "";
}
public static String  _btnservices_click() throws Exception{
 //BA.debugLineNum = 343;BA.debugLine="Private Sub btnServices_Click";
...
_initservices();
 //BA.debugLineNum = 349;BA.debugLine="PanelSelection.RemoveView";
mostCurrent._panelselection.RemoveView();
 //BA.debugLineNum = 350;BA.debugLine="Panel_Selection_Attr(btnServices)";
_panel_selection_attr(mostCurrent._btnservices);
 //BA.debugLineNum = 351;BA.debugLine="scvMain.Visible = False";
mostCurrent._scvmain.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 352;BA.debugLine="End Sub";
return "";
}
public static String  _btnservicesback_click() throws Exception{
 //BA.debugLineNum = 513;BA.debugLine="Private Sub btnServicesBack_Click";
 //BA.debugLineNum = 514;BA.debugLine="btnHome_Click";
_btnhome_click();
...
int _y = 0;
int _x = 0;
 //BA.debugLineNum = 673;BA.debugLine="Sub ChangeColorBasedOnAlphaLevel(bmp As B4XBitmap,";
 //BA.debugLineNum = 674;BA.debugLine="Dim bc As BitmapCreator";
mostCurrent._bc = new b4a.example.bitmapcreator();
 //BA.debugLineNum = 675;BA.debugLine="bc.Initialize(bmp.Width, bmp.Height)";
mostCurrent._bc._initialize(processBA,(int) (_bmp.getWidth()),(int) (_bmp.getHeight()));
 //BA.debugLineNum = 676;BA.debugLine="bc.CopyPixelsFromBitmap(bmp)";
mostCurrent._bc._copypixelsfrombitmap(_bmp);
 //BA.debugLineNum = 677;BA.debugLine="Dim a1, a2 As ARGBColor";
_a1 = new b4a.example.bitmapcreator._argbcolor();
_a2 = new b4a.example.bitmapcreator._argbcolor();
 //BA.debugLineNum = 678;BA.debugLine="bc.ColorToARGB(NewColor, a1)";
mostCurrent._bc._colortoargb(_newcolor,_a1);
 //BA.debugLineNum = 679;BA.debugLine="For y = 0 To bc.mHeight - 1";
{
final int step6 = 1;
final int limit6 = (int) (mostCurrent._bc._mheight-1);
_y = (int) (0) ;
for (;_y <= limit6 ;_y = _y + step6 ) {
 //BA.debugLineNum = 680;BA.debugLine="For x = 0 To bc.mWidth - 1";
{
final int step7 = 1;
final int limit7 = (int) (mostCurrent._bc._mwidth-1);
_x = (int) (0) ;
for (;_x <= limit7 ;_x = _x + step7 ) {
 //BA.debugLineNum = 681;BA.debugLine="bc.GetARGB(x, y, a2)";
mostCurrent._bc._getargb(_x,_y,_a2);
 //BA.debugLineNum = 682;BA.debugLine="If a2.a > 0 Then";
if (_a2.a>0) { 
 //BA.debugLineNum = 683;BA.debugLine="a2.r = a1.r";
_a2.r = _a1.r;
 //BA.debugLineNum = 684;BA.debugLine="a2.g = a1.g";
_a2.g = _a1.g;
 //BA.debugLineNum = 685;BA.debugLine="a2.b = a1.b";
_a2.b = _a1.b;
 //BA.debugLineNum = 686;BA.debugLine="bc.SetARGB(x, y, a2)";
mostCurrent._bc._setargb(_x,_y,_a2);
 ...
 //BA.debugLineNum = 690;BA.debugLine="Return bc.Bitmap";
...
//C
this.state = 1;
 //BA.debugLineNum = 211;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
 //BA.debugLineNum = 213;BA.debugLine="Wait For (p.ShellAsync(\"ping\", Array As String(\"-";
...
;
 //BA.debugLineNum = 214;BA.debugLine="If StdErr = \"\" And StdOut.Contains(\"Destination H";
if (true) break;
...
public static String  _checkpermissions() throws Exception{
 //BA.debugLineNum = 195;BA.debugLine="Private Sub CheckPermissions";
 //BA.debugLineNum = 196;BA.debugLine="Log(\"Checking Permissions\")";
anywheresoftware.b4a.keywords.Common.LogImpl("3589825","Checking Permissions",0);
 //BA.debugLineNum = 198;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_READ_EXTERNAL_STORAGE);
 //BA.debugLineNum = 199;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_WRITE_EXTERNAL_STORAGE);
 //BA.debugLineNum = 200;BA.debugLine="GlobalVariables.RTP.CheckAndRequest(GlobalVariabl";
mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .CheckAndRequest(processBA,mostCurrent._globalvariables._rtp /*anywheresoftware.b4a.objects.RuntimePermissions*/ .PERMISSION_ACCESS_COARSE_LOCATION);
 //BA.debugLineNum = 201;BA.debugLine="GlobalVariables.RTP.GetAllSafeDirsExternal(\"\")";
...
Object[] _v = null;
 //BA.debugLineNum = 271;BA.debugLine="Private Sub clvNews_ItemClick (Index As Int, Value";
 //BA.debugLineNum = 272;BA.debugLine="Dim v() As Object = Value";
_v = (Object[])(_value);
 //BA.debugLineNum = 273;BA.debugLine="Dim Index As Int = v(0)";
_index = (int)(BA.ObjectToNumber(_v[(int) (0)]));
 //BA.debugLineNum = 274;BA.debugLine="SelectedNews = v(1)";
_selectednews = (com.bwsi.cares.main._mynews)(_v[(int) (1)]);
 //BA.debugLineNum = 275;BA.debugLine="StartActivity(NewsPage)";
...
com.bwsi.cares.bblistitem _bb = null;
 //BA.debugLineNum = 398;BA.debugLine="Private Sub clvServices_ScrollChanged (Offset As I";
 //BA.debugLineNum = 399;BA.debugLine="For i = 0 To clvServices.Size - 1";
{
final int step1 = 1;
final int limit1 = (int) (mostCurrent._clvservices._getsize()-1);
_i = (int) (0) ;
for (;_i <= limit1 ;_i = _i + step1 ) {
 //BA.debugLineNum = 400;BA.debugLine="Dim pnl As B4XView = clvServices.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvservices._getpanel(_i);
 //BA.debugLineNum = 401;BA.debugLine="If pnl.NumberOfViews = 0 Then Return";
if (_pnl.getNumberOfViews()==0) { 
if (true) return "";};
 //BA.debugLineNum = 402;BA.debugLine="Dim BB As BBListItem = pnl.GetView(1).GetView(BB";
_bb = (com.bwsi.cares.bblistitem)(_pnl.GetView((int) (1)).GetView(_bblistitemindexinitems).getTag());
 //BA.debugLineNum = 403;BA.debugLine="BB.ParentScrolled(Offset, clvServices.GetRawList";
...
public static String  _clvservices_visiblerangechanged(int _firstindex,int _lastindex) throws Exception{
 //BA.debugLineNum = 422;BA.debugLine="Private Sub clvServices_VisibleRangeChanged (First";
...
com.bwsi.cares.main._mynews _info = null;
 //BA.debugLineNum = 247;BA.debugLine="Sub CreateItem()";
 //BA.debugLineNum = 248;BA.debugLine="For i = 0 To 3";
{
final int step1 = 1;
final int limit1 = (int) (3);
_i = (int) (0) ;
for (;_i <= limit1 ;_i = _i + step1 ) {
 //BA.debugLineNum = 249;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
_p = new anywheresoftware.b4a.objects.B4XViewWrapper();
_p = mostCurrent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 250;BA.debugLine="Dim height As Int = 100%y";
_height = anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA);
 //BA.debugLineNum = 251;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 100%x , height)";
_p.SetLayoutAnimated((int) (0),(int) (0),(int) (0),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_height);
 //BA.debugLineNum = 252;BA.debugLine="p.LoadLayout(\"NewsCards\")";
_p.LoadLayout("NewsCards",mostCurrent.activityBA);
 //BA.debugLineNum = 253;BA.debugLine="Dim Info As MyNews";
_info = new com.bwsi.cares.main._mynews();
 //BA.debugLineNum = 255;BA.debugLine="imgNews.Bitmap = bitmp(i)";
...
int _i = 0;
 //BA.debugLineNum = 381;BA.debugLine="Private Sub CreateItemText(index As Int) As String";
 //BA.debugLineNum = 382;BA.debugLine="Dim sb As StringBuilder";
_sb = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 383;BA.debugLine="sb.Initialize";
_sb.Initialize();
 //BA.debugLineNum = 384;BA.debugLine="sb.Append($\"[alignment=center][b]Item #${index}[/";
_sb.Append(("[alignment=center][b]Item #"+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(_index))+"[/b][/alignment]"));
 //BA.debugLineNum = 385;BA.debugLine="For i = 1 To Rnd(1, 20)";
{
final int step4 = 1;
final int limit4 = anywheresoftware.b4a.keywords.Common.Rnd((int) (1),(int) (20));
_i = (int) (1) ;
for (;_i <= limit4 ;_i = _i + step4 ) {
 //BA.debugLineNum = 386;BA.debugLine="sb.Append(CRLF).Append($\"[u]Line ${i}[/u]: [colo";
...
public static String  _dosomething_tick() throws Exception{
 //BA.debugLineNum = 180;BA.debugLine="Private Sub DoSomething_Tick";
 //BA.debugLineNum = 181;BA.debugLine="Log(\"WORKING...\")";
anywheresoftware.b4a.keywords.Common.LogImpl("3393217","WORKING...",0);
 //BA.debugLineNum = 182;BA.debugLine="End Sub";
return "";
}
public static String  _fabapply_click() throws Exception{
 //BA.debugLineNum = 331;BA.debugLine="Private Sub fabApply_Click";
 //BA.debugLineNum = 332;BA.debugLine="StartActivity(DataPrivacyPage)";
...
String _content = "";
 //BA.debugLineNum = 517;BA.debugLine="Private Sub GetContent(iServiceID As Int) As Strin";
 //BA.debugLineNum = 518;BA.debugLine="Private Content As String";
_content = "";
 //BA.debugLineNum = 520;BA.debugLine="Select iServiceID";
switch (_iserviceid) {
case 1: {
 //BA.debugLineNum = 522;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Sourcing o";
_content = ("[TextSize=14][INDENT=1]Sourcing of underground water reservoirs, also [/INDENT][alignment=justify]known as [b]groundwater sourcing or groundwater exploration[/b], refers to the process of locating and accessing underground water supplies or aquifers for various purposes, such as drinking water supply, irrigation, industrial use, or environmental restoration. This is an essential activity in regions where surface water sources may be insufficient or unreliable.\n"+"Here are the general steps involved in the sourcing of underground water reservoirs:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Site Assessment\n"+"[*]Geophysical Surveys\n"+"[*]Exploratory Drilling\n"+"[*]Aquifer Testing\n"+"[*]Water Quality Analysis\n"+"[*]Well Design and Construction\n"+"[*]Pumping and Monitoring\n"+"[*]Regulatory Compliance\n"+"[*]Maintenance and Rehabilitation\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 2: {
 //BA.debugLineNum = 537;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]The instal";
_content = ("[TextSize=14][INDENT=1]The installation of pumps and motors[/INDENT][alignment=justify] is a common process in various applications, including water supply systems, industrial processes, agricultural irrigation, and more. Proper installation is crucial to ensure the efficient and safe operation of these components.\n"+"Here are the general steps involved in the installation of pumps and motors:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Site Preparation\n"+"[*]Foundation Construction\n"+"[*]Electrical Wiring\n"+"[*]Alignment\n"+"[*]Coupling Installation (if applicable\n"+"[*]Piping and Plumbing\n"+"[*]Prime the Pump (if applicable\n"+"[*]Motor Alignment and Coupling Tightening (if applicable\n"+"[*]Start-Up and Testing\n"+"[*]Safety Measures\n"+"[*]Documentation\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 3: {
 //BA.debugLineNum = 554;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Laying mai";
_content = ("[TextSize=14][INDENT=1]Laying mainline distribution pipes is a [/INDENT][alignment=justify]crucial step in establishing a water distribution system for supplying water to homes, businesses, and other end-users. This process involves the installation of large-diameter pipes that serve as the primary conveyance system for transporting water from the source (such as a treatment plant or well) to various distribution points.\n"+"Here are the key steps involved in laying mainline distribution pipes:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Design and Planning\n"+"[*]Materials and Equipment Preparation\n"+"[*]Route Survey and Marking\n"+"[*]Excavation and Trenching\n"+"[*]Bedding and Backfill\n"+"[*]Pipe Installation\n"+"[*]Pressure Testing\n"+"[*]Disinfection and Flushing\n"+"[*]Connection to Source and Distribution Points\n"+"[*]Testing and Commissioning\n"+"[*]Documentation and Record Keeping\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 4: {
 //BA.debugLineNum = 571;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Chlorinati";
_content = ("[TextSize=14][INDENT=1]Chlorination of water sources is a [/INDENT][alignment=justify]common and effective method of disinfecting water to make it safe for consumption and other uses. Chlorine is added to water to kill or inactivate harmful microorganisms, such as bacteria, viruses, and parasites, that may be present in the water. Chlorination is widely used in public water supply systems, industrial processes, and swimming pools, among other applications.\n"+"Here's an overview of the chlorination process for water sources:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Selection of Chlorine Compound\n"+"[*]Dosage Determination\n"+"[*]Chlorine Addition\n"+"[*]Contact Time\n"+"[*]Residual Chlorine Monitoring\n"+"[*]Adjustment of Ph\n"+"[*]Dechlorination (if required\n"+"[*]Sampling and Testing\n"+"[*]Safety Precautions\n"+"[*]Documentation\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 5: {
 //BA.debugLineNum = 587;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Filtration";
_content = ("[TextSize=14][INDENT=1]Filtration of surface water sources is a [/INDENT][alignment=justify]critical step in the treatment of water to make it safe for consumption and other uses. Surface water sources, such as rivers, lakes, and reservoirs, often contain suspended particles, sediments, algae, bacteria, and other impurities that need to be removed. Filtration is an essential part of the water treatment process and helps improve the water's clarity, taste, and safety.\n"+"Here's an overview of the filtration process for surface water sources:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Coagulation and Flocculation\n"+"[*]Screening (Optional\n"+"[*]Filtration Media Selection\n"+"[*]Filter Bed Preparation\n"+"[*]Filtration Process\n"+"[*]Backwashing (Cleaning)\n"+"[*]Disinfection (Optional)\n"+"[*]Post-Filtration Treatment (if needed)\n"+"[*]Quality Monitoring\n"+"[*]Distribution\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 6: {
 //BA.debugLineNum = 603;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Connecting";
_content = ("[TextSize=14][INDENT=1]Connecting households and businesses to [/INDENT][alignment=justify]mainlines, often referred to as water or utility mains, is a crucial step in providing these consumers with access to essential services like water supply, natural gas, electricity, or telecommunications. The process of connecting properties to mainlines varies depending on the type of utility being provided and local regulations.\n"+"Here is a general overview of the steps involved in connecting households and businesses to mainlines:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Application and Permits\n"+"[*]Utility Assessment and Planning\n"+"[*]Design and Engineering\n"+"[*]Construction and Installation\n"+"[*]Connection to Property\n"+"[*]Inspection and Testing\n"+"[*]Connection Activation\n"+"[*]Billing and Service Agreements\n"+"[*]Ongoing Maintenance and Service\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 7: {
 //BA.debugLineNum = 618;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Meter read";
_content = ("[TextSize=14][INDENT=1]Meter reading, billing, and payment collection are[/INDENT][alignment=justify] crucial components of utility services, such as electricity, water, gas, and telecommunications. These processes ensure that consumers are accurately billed for the services they use and enable utility providers to maintain their infrastructure and operations.\n"+"Here's an overview of each of these processes:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Meter Reading\n"+"[*]Billing\n"+"[*]Payment Collection\n"+"[*]Customer Support and Dispute Resolution\n"+"[*]Meter Maintenance and Replacement\n"+"[*]Data Security and Privacy\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 8: {
 //BA.debugLineNum = 630;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]After-sale";
_content = ("[TextSize=14][INDENT=1]After-sales services for utilities, including repairs [/INDENT][alignment=justify]of leaks and broken meters, are essential for maintaining the reliability and functionality of utility services and ensuring customer satisfaction. \n"+"Here's an overview of the after-sales services related to utility repairs:\n"+"[/Alignment][/TextSize][b][list style=ordered][TextSize=14][color=#2A91C3]\n"+"[*]Customer Reporting\n"+"[*]Issue Assessment\n"+"[*]Dispatching Technicians\n"+"[*]Meter Replacement or Repair\n"+"[*]Leak Repair\n"+"[*]Emergency Response\n"+"[*]Safety Measures\n"+"[*]Communication with Customers\n"+"[*]Quality Assurance\n"+"[*]Testing and Verification\n"+"[*]Billing Adjustments\n"+"[*]Customer Feedback\n"+"[/color][/TextSize][/list][/b]");
 break; }
case 9: {
 //BA.debugLineNum = 648;BA.debugLine="Content = _ $\"[TextSize=14][INDENT=1]Reducing n";
...
;
 //BA.debugLineNum = 667;BA.debugLine="Return Content";
...
mostCurrent._panelselection = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private btnAccount As ImageView";
mostCurrent._btnaccount = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 37;BA.debugLine="Private btnBranches As ImageView";
mostCurrent._btnbranches = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private btnCallUs As ImageView";
mostCurrent._btncallus = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private btnHome As ImageView";
mostCurrent._btnhome = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 40;BA.debugLine="Private btnServices As ImageView";
mostCurrent._btnservices = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 42;BA.debugLine="Private pnlSplash As Panel";
mostCurrent._pnlsplash = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 43;BA.debugLine="Private bitmp(4) As Bitmap";
...
;
 //BA.debugLineNum = 44;BA.debugLine="Private strNewsTitle(4), strNewsDesc(4), strAutho";
...
java.util.Arrays.fill(mostCurrent._strdate,"");
 //BA.debugLineNum = 46;BA.debugLine="Private imgNews As B4XImageView";
mostCurrent._imgnews = new com.bwsi.cares.b4ximageview();
 //BA.debugLineNum = 47;BA.debugLine="Private lblNewsTitle As Label";
...
mostCurrent._lblauthor = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 49;BA.debugLine="Private clvNews As CustomListView";
mostCurrent._clvnews = new b4a.example3.customlistview();
 //BA.debugLineNum = 50;BA.debugLine="Private lblDate As Label";
mostCurrent._lbldate = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Private imgAbout As B4XImageView";
mostCurrent._imgabout = new com.bwsi.cares.b4ximageview();
 //BA.debugLineNum = 52;BA.debugLine="Private pnlAccount As Panel";
mostCurrent._pnlaccount = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 53;BA.debugLine="Private pnlServices As Panel";
mostCurrent._pnlservices = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 56;BA.debugLine="Private lblCheck As Label";
mostCurrent._lblcheck = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 57;BA.debugLine="Private lblEmail As Label";
mostCurrent._lblemail = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 58;BA.debugLine="Private lblForgotPassword As Label";
mostCurrent._lblforgotpassword = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 59;BA.debugLine="Private lblLogin As Label";
mostCurrent._lbllogin = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 60;BA.debugLine="Private lblPassword As Label";
mostCurrent._lblpassword = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 61;BA.debugLine="Private pnlLogin As Panel";
mostCurrent._pnllogin = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 62;BA.debugLine="Private txtLoginEMail As EditText";
mostCurrent._txtloginemail = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 63;BA.debugLine="Private txtLoginPassword As EditText";
mostCurrent._txtloginpassword = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 68;BA.debugLine="Private TextEngine As BCTextEngine";
mostCurrent._textengine = new com.bwsi.cares.bctextengine();
 //BA.debugLineNum = 71;BA.debugLine="Private BBListItemIndexInItems As Int = 0";
_bblistitemindexinitems = (int) (0);
 //BA.debugLineNum = 72;BA.debugLine="Private Expandable As CLVExpandable";
mostCurrent._expandable = new com.bwsi.cares.clvexpandable();
 //BA.debugLineNum = 73;BA.debugLine="Private FadeBitmap As B4XBitmap";
mostCurrent._fadebitmap = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
 //BA.debugLineNum = 74;BA.debugLine="Private bc As BitmapCreator";
mostCurrent._bc = new b4a.example.bitmapcreator();
 //BA.debugLineNum = 77;BA.debugLine="Private btnServicesBack As Label";
mostCurrent._btnservicesback = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 79;BA.debugLine="Private fabApply As FloatingActionButton";
mostCurrent._fabapply = new de.donmanfred.FloatingActionButtonWrapper();
 //BA.debugLineNum = 80;BA.debugLine="Private clvServices As CustomListView";
mostCurrent._clvservices = new b4a.example3.customlistview();
 //BA.debugLineNum = 82;BA.debugLine="Private lblServices As Label";
mostCurrent._lblservices = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 83;BA.debugLine="Private lblDot As Label";
mostCurrent._lbldot = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 86;BA.debugLine="Private lblViewAll As Label";
mostCurrent._lblviewall = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 89;BA.debugLine="Private cdTxtBox As ColorDrawable";
...
//C
this.state = -1;
 //BA.debugLineNum = 224;BA.debugLine="Return mXUI.LoadBitmapResize(File.DirAssets,$\"web";
if (true) {
...
public static String  _initializedatas() throws Exception{
 //BA.debugLineNum = 278;BA.debugLine="Sub InitializeDatas";
 //BA.debugLineNum = 279;BA.debugLine="bitmp(0) = LoadBitmap(File.DirAssets,\"News1.jpg\")";
mostCurrent._bitmp[(int) (0)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News1.jpg");
 //BA.debugLineNum = 280;BA.debugLine="bitmp(1) = LoadBitmap(File.DirAssets,\"News2.jpg\")";
mostCurrent._bitmp[(int) (1)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News2.jpg");
 //BA.debugLineNum = 281;BA.debugLine="bitmp(2) = LoadBitmap(File.DirAssets,\"News6.jpg\")";
mostCurrent._bitmp[(int) (2)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News6.jpg");
 //BA.debugLineNum = 282;BA.debugLine="bitmp(3) = LoadBitmap(File.DirAssets,\"News4.png\")";
mostCurrent._bitmp[(int) (3)] = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"News4.png");
 //BA.debugLineNum = 284;BA.debugLine="strNewsTitle(0) = \"Happy 65th anniversary, BWSI\"";
mostCurrent._strnewstitle[(int) (0)] = "Happy 65th anniversary, BWSI";
 //BA.debugLineNum = 285;BA.debugLine="strAuthor(0) = Chr(0xF044) & \" Balibago Waterwork";
mostCurrent._strauthor[(int) (0)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf044)))+" Balibago Waterworks";
 //BA.debugLineNum = 286;BA.debugLine="strDate(0) = Chr(0xF073) & \" 2023-05-21\"";
mostCurrent._strdate[(int) (0)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf073)))+" 2023-05-21";
 //BA.debugLineNum = 287;BA.debugLine="strNewsDesc(0) = _ $\"[Alignment=justify][TextSize";
mostCurrent._strnewsdesc[(int) (0)] = ("[Alignment=justify][TextSize=15]From humble beginnings To a beacon of progress, we have been making waves in providing clean, healthy, And potable water services To almost two million people now. Let us honor our legacy And embrace the winds of change, ensuring a brighter, greener, And sustainable future For generations To come.\n"+"[b]Happy 65th Anniversary, BWSI![/b][/TextSize][/Alignment]");
 //BA.debugLineNum = 291;BA.debugLine="strNewsTitle(1) = \"World Water Day 2023!\"";
mostCurrent._strnewstitle[(int) (1)] = "World Water Day 2023!";
 //BA.debugLineNum = 292;BA.debugLine="strAuthor(1) = Chr(0xF044) & \" Balibago Waterwork";
mostCurrent._strauthor[(int) (1)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf044)))+" Balibago Waterworks";
 //BA.debugLineNum = 293;BA.debugLine="strDate(1) = Chr(0xF073) & \" 2023-01-12\"";
mostCurrent._strdate[(int) (1)] = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(((int)0xf073)))+" 2023-01-12";
 //BA.debugLineNum = 294;BA.debugLine="strNewsDesc(1) = _ $\"[Alignment=justify][TextSize";
...
//C
this.state = 1;
 //BA.debugLineNum = 427;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 428;BA.debugLine="clvServices.Clear";
...
this.state = 4;
this.catchState = 21;
 //BA.debugLineNum = 430;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblServices";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblServices "+"ORDER BY id ASC";
 //BA.debugLineNum = 433;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 434;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
;
 //BA.debugLineNum = 436;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 437;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 438;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 10;
 //BA.debugLineNum = 439;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent.mostCurrent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 440;BA.debugLine="Pnl.SetLayoutAnimated(0, 0, 0, clvServices.AsV";
...
_ex.ExpandedHeight /*int*/  = (int) (anywheresoftware.b4a.keywords.Common.Max(_ex.CollapsedHeight /*int*/ ,_bb._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (20))+_titlepnl.getHeight()));
 //BA.debugLineNum = 453;BA.debugLine="Dim fade As B4XView = Pnl.GetView(1).GetView(1";
_fade = new anywheresoftware.b4a.objects.B4XViewWrapper();
_fade = _pnl.GetView((int) (1)).GetView((int) (1));
 //BA.debugLineNum = 454;BA.debugLine="Dim Arrow As B4XView = Pnl.GetView(0).GetView(";
_arrow = new anywheresoftware.b4a.objects.B4XViewWrapper();
_arrow = _pnl.GetView((int) (0)).GetView((int) (2));
 //BA.debugLineNum = 457;BA.debugLine="If ex.ExpandedHeight > ex.CollapsedHeight Then";
if (true) break;
...
//C
this.state = 15;
 //BA.debugLineNum = 458;BA.debugLine="Arrow.Visible = True";
_arrow.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 459;BA.debugLine="fade.Visible = True";
_fade.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 461;BA.debugLine="fade.Top = ex.CollapsedHeight - fade.Height -";
_fade.setTop((int) (_ex.CollapsedHeight /*int*/ -_fade.getHeight()-_titlepnl.getHeight()));
 //BA.debugLineNum = 462;BA.debugLine="bc.SetBitmapToImageView(FadeBitmap, fade)";
...
//C
this.state = 15;
 //BA.debugLineNum = 464;BA.debugLine="Arrow.Visible = False";
_arrow.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 465;BA.debugLine="fade.Visible = False";
...
this.state = 7;
;
 //BA.debugLineNum = 467;BA.debugLine="Pnl.SetLayoutAnimated(0, 0, 0, Pnl.Width, ex.C";
_pnl.SetLayoutAnimated((int) (0),(int) (0),(int) (0),_pnl.getWidth(),_ex.CollapsedHeight /*int*/ );
 //BA.debugLineNum = 468;BA.debugLine="clvServices.Add(Pnl, ex)";
...
this.state = 22;
this.catchState = 0;
 //BA.debugLineNum = 477;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("31900595",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
this.catchState = 0;
;
 //BA.debugLineNum = 510;BA.debugLine="clvServices_ScrollChanged(0)";
...
public static String  _lblviewall_click() throws Exception{
 //BA.debugLineNum = 760;BA.debugLine="Private Sub lblViewAll_Click";
 //BA.debugLineNum = 761;BA.debugLine="StartActivity(FAQsPage)";
...
int _left = 0;
 //BA.debugLineNum = 728;BA.debugLine="Sub Panel_Selection_Attr(Selection As ImageView)";
 //BA.debugLineNum = 730;BA.debugLine="btnHome.Bitmap = LoadBitmap(File.DirAssets,\"Home.";
mostCurrent._btnhome.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Home.png").getObject()));
 //BA.debugLineNum = 731;BA.debugLine="btnAccount.Bitmap = LoadBitmap(File.DirAssets,\"Us";
mostCurrent._btnaccount.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"User.png").getObject()));
 //BA.debugLineNum = 732;BA.debugLine="btnCallUs.Bitmap = LoadBitmap(File.DirAssets,\"cal";
mostCurrent._btncallus.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"callus.png").getObject()));
 //BA.debugLineNum = 733;BA.debugLine="btnBranches.Bitmap = LoadBitmap(File.DirAssets,\"h";
mostCurrent._btnbranches.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"house-flood.png").getObject()));
 //BA.debugLineNum = 734;BA.debugLine="btnServices.Bitmap =  LoadBitmap(File.DirAssets,\"";
mostCurrent._btnservices.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"services.png").getObject()));
 //BA.debugLineNum = 736;BA.debugLine="Select Selection";
switch (BA.switchObjectToInt(_selection,mostCurrent._btnhome,mostCurrent._btnaccount,mostCurrent._btncallus,mostCurrent._btnbranches,mostCurrent._btnservices)) {
case 0: {
 //BA.debugLineNum = 738;BA.debugLine="Dim bmp As B4XBitmap = LoadBitmap(File.DirAsset";
_bmp = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Home.png").getObject()));
 break; }
case 1: {
 //BA.debugLineNum = 740;BA.debugLine="Dim bmp As B4XBitmap = LoadBitmap(File.DirAsset";
_bmp = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"User.png").getObject()));
 break; }
case 2: {
 //BA.debugLineNum = 742;BA.debugLine="Dim bmp As B4XBitmap = LoadBitmap(File.DirAsset";
_bmp = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"callus.png").getObject()));
 break; }
case 3: {
 //BA.debugLineNum = 744;BA.debugLine="Dim bmp As B4XBitmap = LoadBitmap(File.DirAsset";
_bmp = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"house-flood.png").getObject()));
 break; }
case 4: {
 //BA.debugLineNum = 746;BA.debugLine="Dim bmp As B4XBitmap = LoadBitmap(File.DirAsset";
_bmp = new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper();
_bmp = (anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper(), (android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"services.png").getObject()));
 break; }
}
;
 //BA.debugLineNum = 748;BA.debugLine="BackgroundAndCornerRadius(PanelSelection,15dip)";
_backgroundandcornerradius((anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(mostCurrent._panelselection.getObject())),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (15)));
 //BA.debugLineNum = 749;BA.debugLine="PanelSelection.Color = GlobalVariables.PriColor1";
mostCurrent._panelselection.setColor((int) (mostCurrent._globalvariables._pricolor1 /*double*/ ));
 //BA.debugLineNum = 750;BA.debugLine="Dim Left As Int";
_left = 0;
 //BA.debugLineNum = 751;BA.debugLine="Left = Selection.Left - 5%x";
_left = (int) (_selection.getLeft()-anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA));
 //BA.debugLineNum = 752;BA.debugLine="Activity.AddView(PanelSelection,Left,91%y,16%x,8%";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._panelselection.getObject()),_left,anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (91),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (16),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (8),mostCurrent.activityBA));
 //BA.debugLineNum = 753;BA.debugLine="SetBitmapWithFitOrFill(Selection, ChangeColorBase";
_setbitmapwithfitorfill((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_selection.getObject())),_changecolorbasedonalphalevel(_bmp,anywheresoftware.b4a.keywords.Common.Colors.White));
 //BA.debugLineNum = 755;BA.debugLine="PanelSelection.SendToBack";
mostCurrent._panelselection.SendToBack();
 //BA.debugLineNum = 756;BA.debugLine="Activity.Color = 0xFFF3FDFF";
...
public static String  _pnlaboutus_click() throws Exception{
 //BA.debugLineNum = 238;BA.debugLine="Private Sub pnlAboutUs_Click";
 //BA.debugLineNum = 239;BA.debugLine="timer1.Enabled = False";
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 240;BA.debugLine="StartActivity(HistoryPage)";
...
com.bwsi.cares.clvexpandable._expandableitemdata _e = null;
 //BA.debugLineNum = 408;BA.debugLine="Private Sub pnlServiceTitle_Click";
 //BA.debugLineNum = 412;BA.debugLine="Dim index As Int = clvServices.GetItemFromView(Se";
_index = mostCurrent._clvservices._getitemfromview((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA))));
 //BA.debugLineNum = 413;BA.debugLine="Dim Fade As B4XView = clvServices.GetPanel(index)";
_fade = new anywheresoftware.b4a.objects.B4XViewWrapper();
_fade = mostCurrent._clvservices._getpanel(_index).GetView((int) (1)).GetView((int) (1));
 //BA.debugLineNum = 414;BA.debugLine="Dim e As ExpandableItemData = Expandable.ToggleIt";
_e = mostCurrent._expandable._toggleitem /*com.bwsi.cares.clvexpandable._expandableitemdata*/ (_index);
 //BA.debugLineNum = 415;BA.debugLine="If e.ExpandedHeight <> e.CollapsedHeight Then";
if (_e.ExpandedHeight /*int*/ !=_e.CollapsedHeight /*int*/ ) { 
 //BA.debugLineNum = 416;BA.debugLine="Fade.SetVisibleAnimated(100dip, Not(e.Expanded))";
_fade.SetVisibleAnimated(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (100)),anywheresoftware.b4a.keywords.Common.Not(_e.Expanded /*boolean*/ ));
 ...
 //BA.debugLineNum = 418;BA.debugLine="clvServices_ScrollChanged(clvServices.sv.ScrollVi";
...
public static String  _pnlsplash_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 189;BA.debugLine="Private Sub pnlSplash_Touch (Action As Int, X As F";
...
public static String  _scvmain_scrollchanged(int _position) throws Exception{
 //BA.debugLineNum = 233;BA.debugLine="Sub scvMain_ScrollChanged(Position As Int)";
...
anywheresoftware.b4a.objects.ImageViewWrapper _iv = null;
 //BA.debugLineNum = 693;BA.debugLine="Public Sub SetBitmapWithFitOrFill (vTargetView As";
 //BA.debugLineNum = 694;BA.debugLine="vTargetView.SetBitmap(bmp)";
_vtargetview.SetBitmap((android.graphics.Bitmap)(_bmp.getObject()));
 //BA.debugLineNum = 698;BA.debugLine="Dim iv As ImageView = vTargetView";
...
anywheresoftware.b4j.object.JavaObject _jo2 = null;
 //BA.debugLineNum = 710;BA.debugLine="Sub SetStatusBarAndNavigationColor(clr As Int)";
 //BA.debugLineNum = 711;BA.debugLine="Try";
try { //BA.debugLineNum = 712;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 713;BA.debugLine="jo.InitializeContext";
_jo.InitializeContext(processBA);
 //BA.debugLineNum = 714;BA.debugLine="Dim window As JavaObject = jo.RunMethodJO(\"getWi";
_window = new anywheresoftware.b4j.object.JavaObject();
_window = _jo.RunMethodJO("getWindow",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 715;BA.debugLine="window.RunMethod(\"addFlags\", Array (0x80000000))";
_window.RunMethod("addFlags",new Object[]{(Object)(((int)0x80000000))});
 //BA.debugLineNum = 717;BA.debugLine="window.RunMethod(\"clearFlags\", Array (0x04000000";
_window.RunMethod("clearFlags",new Object[]{(Object)(((int)0x04000000))});
 //BA.debugLineNum = 718;BA.debugLine="window.RunMethod(\"setStatusBarColor\", Array(clr)";
_window.RunMethod("setStatusBarColor",new Object[]{(Object)(_clr)});
 //BA.debugLineNum = 719;BA.debugLine="Dim jo2 As JavaObject";
_jo2 = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 720;BA.debugLine="jo2.InitializeContext";
_jo2.InitializeContext(processBA);
 //BA.debugLineNum = 721;BA.debugLine="jo2.RunMethodJO(\"getWindow\", Null).RunMethod(\"se";
_jo2.RunMethodJO("getWindow",(Object[])(anywheresoftware.b4a.keywords.Common.Null)).RunMethod("setNavigationBarColor",new Object[]{(Object)(_clr)});
			...
			processBA.setLastException(e12); //BA.debugLineNum = 723;BA.debugLine="ToastMessageShow(\"Some error with your android v";
...
//C
this.state = -1;
 //BA.debugLineNum = 184;BA.debugLine="pnlSplash.Visible = True";
parent.mostCurrent._pnlsplash.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 185;BA.debugLine="Sleep(3000)";
...
this.state = -1;
;
 //BA.debugLineNum = 186;BA.debugLine="pnlSplash.Visible = False";
parent.mostCurrent._pnlsplash.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 187;BA.debugLine="tmrSplash.Enabled = False";
...
public static String  _timer1_tick() throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Private Sub Timer1_Tick";
 //BA.debugLineNum = 227;BA.debugLine="imgSlider.NextImage";
