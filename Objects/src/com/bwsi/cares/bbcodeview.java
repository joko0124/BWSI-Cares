...
public class bbcodeview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.cares.bbcodeview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.cares.bbcodeview.class).invoke(this, new Object[] {null});
        else
...
_paragraph = _mtextengine._prepareforlazydrawing /*com.bwsi.cares.bctextengine._bcparagraph*/ (_runs,_style,_sv);
...
_paragraph = _mtextengine._drawtext /*com.bwsi.cares.bctextengine._bcparagraph*/ (_runs,_style,_foregroundimageview,_sv);
 };
...
_line = (com.bwsi.cares.bctextengine._bctextline)(group6.Get(index6));
