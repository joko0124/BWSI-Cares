...
public class bctextengine extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.bwsi.cares.bctextengine");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.bwsi.cares.bctextengine.class).invoke(this, new Object[] {null});
        else
...
public com.bwsi.cares.bctextengine._bcstyledunderline _defaultunderlinestyle = null;
...
public com.bwsi.cares.bctextengine._bcparagraphstyle _defaultstyle = null;
...
public com.bwsi.cares.bbcodeparser _tagparser = null;
public com.bwsi.cares.bctextengine._bctextchars _emptytextchars = null;
public com.bwsi.cares.b4xset _emojis = null;
...
public com.bwsi.cares.b4xset _vowelscodepoints = null;
public com.bwsi.cares.b4xorderedmap _asyncbcs = null;
...
public com.bwsi.cares.b4xset _rtlchars = null;
...
public com.bwsi.cares.b4xset _arabicnonlinkedletters = null;
public com.bwsi.cares.b4xset _arabiccharsconnectedprev = null;
...
public com.bwsi.cares.bctextengine._bcfontmetrics DefaultColorMetrics;
public int xWidth;
...
DefaultColorMetrics = new com.bwsi.cares.bctextengine._bcfontmetrics();
xWidth = 0;
...
public String Text;
public com.bwsi.cares.bctextengine._bctextchars TextChars;
...
TextColor = 0;
Text = "";
TextChars = new com.bwsi.cares.bctextengine._bctextchars();
...
public com.bwsi.cares.bctextengine._bctextline CurrentLine;
public com.bwsi.cares.bctextengine._bcparagraphstyle Style;
...
CurrentLine = new com.bwsi.cares.bctextengine._bctextline();
Style = new com.bwsi.cares.bctextengine._bcparagraphstyle();
TwoLayers = false;
Width = 0;
Height = 0;
...
public com.bwsi.cares.bctextengine._bcparagraph ParentParagraph;
...
ParentParagraph = new com.bwsi.cares.bctextengine._bcparagraph();
...
public int Width;
public int StartX;
public com.bwsi.cares.bctextengine._bctextchars NotFullTextChars;
public boolean IsMergable;
public anywheresoftware.b4a.objects.collections.List SingleStyleSections;
public com.bwsi.cares.bctextengine._bctextline ParentLine;
public boolean RTL;
public void Initialize() {
IsInitialized = true;
Width = 0;
StartX = 0;
NotFullTextChars = new com.bwsi.cares.bctextengine._bctextchars();
IsMergable = false;
SingleStyleSections = new anywheresoftware.b4a.objects.collections.List();
ParentLine = new com.bwsi.cares.bctextengine._bctextline();
RTL = false;
}
@Override
		public String toString() {
...
public com.bwsi.cares.bctextengine._bctextrun Run;
public int Width;
public int MaxHeightBelowBaseLine;
public int MaxHeightAboveBaseLine;
public com.bwsi.cares.bctextengine._bcunbreakabletext ParentUN;
public com.bwsi.cares.bctextengine._bcfontmetrics fm;
public void Initialize() {
IsInitialized = true;
AbsoluteStartX = 0;
GlyphsAndOffsets = new anywheresoftware.b4a.objects.collections.List();
Run = new com.bwsi.cares.bctextengine._bctextrun();
Width = 0;
MaxHeightBelowBaseLine = 0;
MaxHeightAboveBaseLine = 0;
ParentUN = new com.bwsi.cares.bctextengine._bcunbreakabletext();
fm = new com.bwsi.cares.bctextengine._bcfontmetrics();
}
@Override
		public String toString() {
			return BA.TypeToString(this, false);
...
public boolean IsInitialized;
public com.bwsi.cares.bctextengine._bcglyph Glyph;
public int SpaceBetweenThisAndNext;
public void Initialize() {
IsInitialized = true;
Glyph = new com.bwsi.cares.bctextengine._bcglyph();
...
int _startindex = 0;
int _lastindex = 0;
com.bwsi.cares.bctextengine._bcunbreakabletext _lastun = null;
com.bwsi.cares.bctextengine._bcunbreakabletext _prev = null;
int _i = 0;
...
if (_isunseparator((com.bwsi.cares.bctextengine._bcunbreakabletext)(_ltrlist.Get((int) (0))))) { 
...
if (_isunseparator((com.bwsi.cares.bctextengine._bcunbreakabletext)(_ltrlist.Get(_lastindex)))) { 
...
_lastun = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_ltrlist.Get(_lastindex));
 //BA.debugLineNum = 356;BA.debugLine="Dim prev As BCUnbreakableText = LTRList.Get(Sta";
_prev = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_ltrlist.Get((int) (_startindex-1)));
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_ltrlist.Get(_i));
...
public String  _addparagraphviews(com.bwsi.cares.bctextengine._bcparagraph _par) throws Exception{
...
_v.SetLayoutAnimated((int) (0),(int) (_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getLeft()+_v.getLeft()),(int) (_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getTop()+_v.getTop()),_v.getWidth(),_v.getHeight());
 }
};
 };
...
_defaultunderlinestyle = new com.bwsi.cares.bctextengine._bcstyledunderline();
...
_defaultstyle = new com.bwsi.cares.bctextengine._bcparagraphstyle();
...
_tagparser = new com.bwsi.cares.bbcodeparser();
 //BA.debugLineNum = 51;BA.debugLine="Private EmptyTextChars As BCTextChars";
_emptytextchars = new com.bwsi.cares.bctextengine._bctextchars();
 //BA.debugLineNum = 52;BA.debugLine="Private Emojis As B4XSet";
_emojis = new com.bwsi.cares.b4xset();
...
_vowelscodepoints = new com.bwsi.cares.b4xset();
 //BA.debugLineNum = 59;BA.debugLine="Private AsyncBCs As B4XOrderedMap";
_asyncbcs = new com.bwsi.cares.b4xorderedmap();
...
_rtlchars = new com.bwsi.cares.b4xset();
...
_arabicnonlinkedletters = new com.bwsi.cares.b4xset();
 //BA.debugLineNum = 67;BA.debugLine="Private ArabicCharsConnectedPrev As B4XSet";
_arabiccharsconnectedprev = new com.bwsi.cares.b4xset();
...
public com.bwsi.cares.bctextengine._bctextchars  _createbctextchars(String[] _buffer,int _startindex,int _length) throws Exception{
com.bwsi.cares.bctextengine._bctextchars _t1 = null;
...
_t1 = new com.bwsi.cares.bctextengine._bctextchars();
...
public com.bwsi.cares.bctextengine._bctextchars  _createbctextcharsfromstring(String _s) throws Exception{
byte[] _b = null;
String[] _chars = null;
int _i = 0;
int _bi = 0;
...
public com.bwsi.cares.bctextengine._bctextrun  _createconnectedparent() throws Exception{
com.bwsi.cares.bctextengine._bcconnectedruns _connected = null;
com.bwsi.cares.bctextengine._bctextrun _parent = null;
...
_connected = new com.bwsi.cares.bctextengine._bcconnectedruns();
...
public com.bwsi.cares.bctextengine._bcglyph  _createglyph(String _c,com.bwsi.cares.bctextengine._bcfontmetrics _fontmetrics,boolean _justmeasure) throws Exception{
com.bwsi.cares.bctextengine._bcglyph _g = null;
...
_g = (com.bwsi.cares.bctextengine._bcglyph)(_fontmetrics.Glyphs /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_c)));
...
if (true) return _createglyphfromdefaultcolor(_c,_fontmetrics.DefaultColorMetrics /*com.bwsi.cares.bctextengine._bcfontmetrics*/ ,_fontmetrics.Clr /*int*/ );
 }else {
...
_g = new com.bwsi.cares.bctextengine._bcglyph();
...
public com.bwsi.cares.bctextengine._bcglyph  _createglyphfromdefaultcolor(String _c,com.bwsi.cares.bctextengine._bcfontmetrics _defaultcolormetrics,int _clr) throws Exception{
com.bwsi.cares.bctextengine._bcglyph _blackglyph = null;
com.bwsi.cares.bctextengine._bcglyph _g = null;
byte[] _buffer = null;
...
public String  _createline(com.bwsi.cares.bctextengine._bcparagraph _p) throws Exception{
...
_line = new com.bwsi.cares.bctextengine._bctextline();
...
_line.ParentParagraph /*com.bwsi.cares.bctextengine._bcparagraph*/  = _p;
...
_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/  = _line;
 //BA.debugLineNum = 406;BA.debugLine="End Sub";
return "";
}
public com.bwsi.cares.bctextengine._bctextrun  _createrun(String _text) throws Exception{
...
_r = new com.bwsi.cares.bctextengine._bctextrun();
...
_r.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _createbctextcharsfromstring(_text);
...
public com.bwsi.cares.bctextengine._bcsinglestylesection  _createsinglesection(com.bwsi.cares.bctextengine._bctextrun _run,com.bwsi.cares.bctextengine._bctextchars _textchars,com.bwsi.cares.bctextengine._bcfontmetrics _fontmetrics) throws Exception{
com.bwsi.cares.bctextengine._bcsinglestylesection _single = null;
String _prevchar = "";
com.bwsi.cares.bctextengine._bcglyphandoffset _prevgo = null;
int _i = 0;
String _s = "";
com.bwsi.cares.bctextengine._bcglyphandoffset _go = null;
com.bwsi.cares.bctextengine._bcglyph _g = null;
com.bwsi.cares.bctextengine._bcstyledunderline _u = null;
...
_single = new com.bwsi.cares.bctextengine._bcsinglestylesection();
...
_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/  = _run;
 //BA.debugLineNum = 561;BA.debugLine="single.fm = FontMetrics";
_single.fm /*com.bwsi.cares.bctextengine._bcfontmetrics*/  = _fontmetrics;
 //BA.debugLineNum = 562;BA.debugLine="Dim PrevChar As String";
_prevchar = "";
 //BA.debugLineNum = 563;BA.debugLine="Dim PrevGO As BCGlyphAndOffset";
_prevgo = new com.bwsi.cares.bctextengine._bcglyphandoffset();
...
_go = new com.bwsi.cares.bctextengine._bcglyphandoffset();
...
_prevgo.SpaceBetweenThisAndNext /*int*/  = _getkernspacebetweenchars(_fontmetrics,_prevchar,_s,_prevgo.Glyph /*com.bwsi.cares.bctextengine._bcglyph*/ ,_g);
 }else {
...
_go.Glyph /*com.bwsi.cares.bctextengine._bcglyph*/  = _g;
...
public com.bwsi.cares.bctextengine._bcparagraphstyle  _createstyle() throws Exception{
com.bwsi.cares.bctextengine._bcparagraphstyle _s = null;
...
_s = new com.bwsi.cares.bctextengine._bcparagraphstyle();
...
public com.bwsi.cares.bctextengine._bcunbreakabletext  _createunbreakable(com.bwsi.cares.bctextengine._bctextrun _run,com.bwsi.cares.bctextengine._bctextchars _textchars,com.bwsi.cares.bctextengine._bcfontmetrics _fontmetrics,boolean _isseparator,com.bwsi.cares.bctextengine._bcparagraphstyle _style) throws Exception{
com.bwsi.cares.bctextengine._bcunbreakabletext _unbreakable = null;
com.bwsi.cares.bctextengine._bcsinglestylesection _single = null;
...
_unbreakable = new com.bwsi.cares.bctextengine._bcunbreakabletext();
...
_single.ParentUN /*com.bwsi.cares.bctextengine._bcunbreakabletext*/  = _unbreakable;
...
_unbreakable.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _textchars;
...
public boolean  _detectrtl(com.bwsi.cares.bctextengine._bcunbreakabletext _un) throws Exception{
String _firstchar = "";
int _cp = 0;
...
if (_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Length /*int*/ ==0) { 
...
_firstchar = _un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Buffer /*String[]*/ [_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .StartIndex /*int*/ ];
...
public String  _drawline(com.bwsi.cares.bctextengine._bctextline _line,int _offsety) throws Exception{
com.bwsi.cares.bctextengine._bcunbreakabletext _un = null;
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(group1.Get(index1));
...
public String  _drawparagraph(com.bwsi.cares.bctextengine._bcparagraph _paragraph) throws Exception{
com.bwsi.cares.bctextengine._bctextline _line = null;
...
public String  _drawsingleline(com.bwsi.cares.bctextengine._bctextline _line,anywheresoftware.b4a.objects.B4XViewWrapper _iv,com.bwsi.cares.bctextengine._bcparagraph _par) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public b4a.example.bitmapcreator  _drawsinglelineasync(com.bwsi.cares.bctextengine._bctextline _line,anywheresoftware.b4a.objects.B4XViewWrapper _iv,com.bwsi.cares.bctextengine._bcparagraph _par,Object _target) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public anywheresoftware.b4a.objects.B4XCanvas.B4XRect  _drawsinglelineshared(com.bwsi.cares.bctextengine._bctextline _line,anywheresoftware.b4a.objects.B4XViewWrapper _iv,com.bwsi.cares.bctextengine._bcparagraph _par) throws Exception{
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
_iv.SetLayoutAnimated((int) (0),(int) (_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getLeft()),(int) (_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getTop()+(_line.BaselineY /*int*/ -_line.MaxHeightAboveBaseLine /*int*/ )/(double)_mscale),(int) (_r.getWidth()/(double)_mscale),(int) (_r.getHeight()/(double)_mscale));
 //BA.debugLineNum = 637;BA.debugLine="Return r";
if (true) return _r;
 //BA.debugLineNum = 638;BA.debugLine="End Sub";
return null;
}
public String  _drawsinglestylesection(com.bwsi.cares.bctextengine._bcsinglestylesection _single,int _offsety) throws Exception{
int _offsetx = 0;
boolean _rtl = false;
com.bwsi.cares.bctextengine._bcglyphandoffset _go = null;
com.bwsi.cares.bctextengine._bcglyph _g = null;
...
_rtl = _single.ParentUN /*com.bwsi.cares.bctextengine._bcunbreakabletext*/ .RTL /*boolean*/ ;
...
_go = (com.bwsi.cares.bctextengine._bcglyphandoffset)(group4.Get(index4));
 //BA.debugLineNum = 700;BA.debugLine="Dim g As BCGlyph = go.Glyph";
_g = _go.Glyph /*com.bwsi.cares.bctextengine._bcglyph*/ ;
...
_dt = _asyncbc._createdrawtask((Object)(_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ ),_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ .TargetRect,_x,(int) (_offsety-_g.baseline /*int*/ +_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .VerticalOffset /*int*/ *_mscale),__c.True);
...
_foregroundbc._drawcompressedbitmap(_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ ,_g.cbc /*b4a.example.bitmapcreator._compressedbc*/ .TargetRect,_x,(int) (_offsety-_g.baseline /*int*/ +_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .VerticalOffset /*int*/ *_mscale));
 };
 };
 //BA.debugLineNum = 715;BA.debugLine="If single.Run.Underline Then";
if (_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .Underline /*boolean*/ ) { 
 //BA.debugLineNum = 716;BA.debugLine="Dim u As BCStyledUnderline = GetUnderlineStyle(";
_u = _getunderlinestyle(_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ );
...
if (_clr==0) { 
_clr = _single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .TextColor /*int*/ ;};
...
_r.Initialize((float) (_x),(float) (_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .VerticalOffset /*int*/ *_mscale+_offsety+_mscale),(float) (_x+_g.Width /*int*/ +_mspacebetweencharacters+_go.SpaceBetweenThisAndNext /*int*/ *_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .CharacterSpacingFactor /*float*/ ),(float) (_offsety+_mscale+_u.Thickness /*float*/ *_mscale+_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .VerticalOffset /*int*/ *_mscale));
...
_offsetx = (int) (_offsetx-_g.Width /*int*/ -_go.SpaceBetweenThisAndNext /*int*/ *_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .CharacterSpacingFactor /*float*/ );
 }else {
...
public com.bwsi.cares.bctextengine._bcparagraph  _drawtext(anywheresoftware.b4a.objects.collections.List _runs,com.bwsi.cares.bctextengine._bcparagraphstyle _style,anywheresoftware.b4a.objects.B4XViewWrapper _foregroundimageview,anywheresoftware.b4a.objects.B4XViewWrapper _sv) throws Exception{
com.bwsi.cares.bctextengine._bcparagraph _par = null;
...
_resizeimageview(_foregroundbc,_par,_foregroundimageview,_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .ResizeHeightAutomatically /*boolean*/ );
 };
 //BA.debugLineNum = 212;BA.debugLine="If par.Style.ResizeHeightAutomatically And sv.IsI";
if (_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .ResizeHeightAutomatically /*boolean*/  && _sv.IsInitialized()) { 
 //BA.debugLineNum = 213;BA.debugLine="sv.ScrollViewContentHeight = Max(sv.Height - 2di";
_sv.setScrollViewContentHeight((int) (__c.Max(_sv.getHeight()-__c.DipToCurrent((int) (2)),_foregroundimageview.getHeight()+_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getTop()+_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getBottom())));
 };
...
public String  _drawunbreakable(com.bwsi.cares.bctextengine._bcunbreakabletext _un,int _offsety) throws Exception{
com.bwsi.cares.bctextengine._bcsinglestylesection _single = null;
...
;
for (; index1 < groupLen1;index1++){
_single = (com.bwsi.cares.bctextengine._bcsinglestylesection)(group1.Get(index1));
...
public com.bwsi.cares.bctextengine._bcsinglestylesection  _findsinglestylesection(com.bwsi.cares.bctextengine._bcparagraph _paragraph,int _x,int _y) throws Exception{
com.bwsi.cares.bctextengine._bctextline _line = null;
com.bwsi.cares.bctextengine._bcunbreakabletext _un = null;
com.bwsi.cares.bctextengine._bcsinglestylesection _s = null;
...
_line = (com.bwsi.cares.bctextengine._bctextline)(group3.Get(index3));
...
_s = (com.bwsi.cares.bctextengine._bcsinglestylesection)(group7.Get(index7));
...
if (true) return (com.bwsi.cares.bctextengine._bcsinglestylesection)(__c.Null);
...
public com.bwsi.cares.bctextengine._bcsinglestylesection  _getfirstsinglestyle(com.bwsi.cares.bctextengine._bctextline _line) throws Exception{
com.bwsi.cares.bctextengine._bcunbreakabletext _firstun = null;
...
_firstun = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_line.Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (0)));
 //BA.debugLineNum = 395;BA.debugLine="Return FirstUN.SingleStyleSections.Get(0)";
if (true) return (com.bwsi.cares.bctextengine._bcsinglestylesection)(_firstun.SingleStyleSections /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (0)));
 //BA.debugLineNum = 396;BA.debugLine="End Sub";
return null;
}
public com.bwsi.cares.bctextengine._bcfontmetrics  _getfontmetrics(anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont _fnt,int _clr) throws Exception{
String _key = "";
com.bwsi.cares.bctextengine._bcfontmetrics _fm = null;
...
if (true) return (com.bwsi.cares.bctextengine._bcfontmetrics)(_fontmetricscache.Get((Object)(_key)));};
 //BA.debugLineNum = 797;BA.debugLine="Dim fm As BCFontMetrics";
_fm = new com.bwsi.cares.bctextengine._bcfontmetrics();
...
_fm.DefaultColorMetrics /*com.bwsi.cares.bctextengine._bcfontmetrics*/  = _fm;
...
_fm.DefaultColorMetrics /*com.bwsi.cares.bctextengine._bcfontmetrics*/  = _getfontmetrics(_fnt,_defaultcolor);
 //BA.debugLineNum = 808;BA.debugLine="fm.xWidth = fm.DefaultColorMetrics.xWidth";
_fm.xWidth /*int*/  = _fm.DefaultColorMetrics /*com.bwsi.cares.bctextengine._bcfontmetrics*/ .xWidth /*int*/ ;
 //BA.debugLineNum = 809;BA.debugLine="fm.KerningTable = fm.DefaultColorMetrics.Kerning";
_fm.KerningTable /*anywheresoftware.b4a.objects.collections.Map*/  = _fm.DefaultColorMetrics /*com.bwsi.cares.bctextengine._bcfontmetrics*/ .KerningTable /*anywheresoftware.b4a.objects.collections.Map*/ ;
 };
...
public int  _getkernspacebetweenchars(com.bwsi.cares.bctextengine._bcfontmetrics _fm,String _prevchar,String _thischar,com.bwsi.cares.bctextengine._bcglyph _prevglyph,com.bwsi.cares.bctextengine._bcglyph _thisglyph) throws Exception{
String _together = "";
int _space = 0;
int _res = 0;
int _w = 0;
...
public com.bwsi.cares.bctextengine._bcstyledunderline  _getunderlinestyle(com.bwsi.cares.bctextengine._bctextrun _run) throws Exception{
...
if (true) return (com.bwsi.cares.bctextengine._bcstyledunderline)(_run.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)(_extra_styledunderline),(Object)(_defaultunderlinestyle)));
 //BA.debugLineNum = 739;BA.debugLine="End Sub";
return null;
}
public String  _handleconnectedtextruns(com.bwsi.cares.bctextengine._bctextrun _run,anywheresoftware.b4a.objects.collections.List _unbreakables,com.bwsi.cares.bctextengine._bcparagraphstyle _style) throws Exception{
anywheresoftware.b4a.objects.collections.List _children = null;
com.bwsi.cares.bctextengine._bcconnectedruns _cr = null;
com.bwsi.cares.bctextengine._bctextrun _r = null;
int _width = 0;
com.bwsi.cares.bctextengine._bcunbreakabletext _un = null;
com.bwsi.cares.bctextengine._bcfontmetrics _fm = null;
int _connectedwidth = 0;
com.bwsi.cares.bctextengine._bcunbreakabletext _u = null;
int _i = 0;
int _leftoffset = 0;
com.bwsi.cares.bctextengine._bcsinglestylesection _single = null;
...
_cr = (com.bwsi.cares.bctextengine._bcconnectedruns)(_run.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_extra_connectedruns)));
...
;
for (; index4 < groupLen4;index4++){
_r = (com.bwsi.cares.bctextengine._bctextrun)(group4.Get(index4));
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(group8.Get(index8));
...
_u = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_children.Get((int) (0)));
...
_mergeunbreakables(_u,(com.bwsi.cares.bctextengine._bcunbreakabletext)(_children.Get(_i)));
 }
};
...
public String  _handletextrun(com.bwsi.cares.bctextengine._bctextrun _run,anywheresoftware.b4a.objects.collections.List _unbreakables,com.bwsi.cares.bctextengine._bcparagraphstyle _style) throws Exception{
com.bwsi.cares.bctextengine._bcfontmetrics _fm = null;
int _i1 = 0;
int _i = 0;
String _c = "";
...
{
final int step3 = 1;
final int limit3 = (int) (_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Length /*int*/ -1);
_i = (int) (0) ;
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 450;BA.debugLine="Dim c As String = Run.TextChars.Buffer(Run.TextC";
_c = _run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Buffer /*String[]*/ [(int) (_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .StartIndex /*int*/ +_i)];
...
_unbreakables.Add((Object)(_createunbreakable(_run,_textcharssubstring(_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ,_i1,(int) (_i+_offset)),_fm,__c.True,_style)));
 };
...
_unbreakables.Add((Object)(_createunbreakable(_run,_textcharssubstring(_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ,_i,(int) (_i+1)),_fm,__c.True,_style)));
 }else {
...
if (_i1<_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Length /*int*/ ) { 
_unbreakables.Add((Object)(_createunbreakable(_run,_textcharssubstring(_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ,_i1,_run.TextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Length /*int*/ ),_fm,__c.False,_style)));};
...
_tagparser._initialize /*String*/ (ba,(com.bwsi.cares.bctextengine)(this));
...
if (_v.getTag() instanceof com.bwsi.cares.bbcodeview || _v.getTag() instanceof com.bwsi.cares.bblabel) { 
...
public boolean  _isspace(com.bwsi.cares.bctextengine._bctextchars _tc) throws Exception{
...
public boolean  _isunseparator(com.bwsi.cares.bctextengine._bcunbreakabletext _un) throws Exception{
...
if (true) return _wordboundaries.contains(_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Buffer /*String[]*/ [_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .StartIndex /*int*/ ]);
...
public String  _loaddata(com.bwsi.cares.b4xset _set,String _filename) throws Exception{
String _line = "";
int _i = 0;
int _a = 0;
...
public String  _mergeunbreakables(com.bwsi.cares.bctextengine._bcunbreakabletext _un1,com.bwsi.cares.bctextengine._bcunbreakabletext _un2) throws Exception{
com.bwsi.cares.bctextengine._bcsinglestylesection _single = null;
...
;
for (; index2 < groupLen2;index2++){
_single = (com.bwsi.cares.bctextengine._bcsinglestylesection)(group2.Get(index2));
 //BA.debugLineNum = 548;BA.debugLine="single.ParentUN = un1";
_single.ParentUN /*com.bwsi.cares.bctextengine._bcunbreakabletext*/  = _un1;
 }
};
...
if (_un1.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ .Length /*int*/ ==0) { 
_un1.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/  = _un2.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ;};
...
public String  _organizelines(com.bwsi.cares.bctextengine._bcparagraph _p) throws Exception{
...
int _maxwidth = 0;
String _alignment = "";
com.bwsi.cares.bctextengine._bcsinglestylesection _linestyle = null;
com.bwsi.cares.bctextengine._bcunbreakabletext _last = null;
int _numberofgaps = 0;
float _delta = 0f;
...
_paralignment = _p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .HorizontalAlignment /*String*/ .toLowerCase();
...
;
for (; index4 < groupLen4;index4++){
_line = (com.bwsi.cares.bctextengine._bctextline)(group4.Get(index4));
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(group6.Get(index6));
...
;
for (; index7 < groupLen7;index7++){
_single = (com.bwsi.cares.bctextengine._bcsinglestylesection)(group7.Get(index7));
...
_line.Height /*int*/  = (int) (__c.Max(_line.MaxHeightAboveBaseLine /*int*/ +_prevlinebelowbaselineheight+_mmingapbetweenlines*_mscale,_mspacebetweenlines*_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .LineSpacingFactor /*float*/ ));
 };
...
_maxwidth = (int) ((_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .MaxWidth /*int*/ -_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getLeft()-_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getRight())*_mscale);
...
_line = (com.bwsi.cares.bctextengine._bctextline)(group26.Get(index26));
...
if ((_linestyle.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .HorizontalAlignment /*String*/ ).equals("")) { 
_alignment = _paralignment;}
else {
_alignment = _linestyle.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .HorizontalAlignment /*String*/ .toLowerCase();};
...
if (_linestyle.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .IndentLevel /*int*/ >0) { 
 //BA.debugLineNum = 268;BA.debugLine="line.StartX = IndentWidth * linestyle.Run.Inde";
_line.StartX /*int*/  = (int) (_indentwidth*_linestyle.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .IndentLevel /*int*/ );
...
_last = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_line.Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (_line.Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .getSize()-1)));
 //BA.debugLineNum = 282;BA.debugLine="If IsSpace(last.NotFullTextChars) Then";
if (_isspace(_last.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ )) { 
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(group54.Get(index54));
...
public String  _organizertlparagraph(com.bwsi.cares.bctextengine._bcparagraph _par) throws Exception{
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(group16.Get(index16));
...
_single = (com.bwsi.cares.bctextengine._bcsinglestylesection)(group19.Get(index19));
...
if (_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .IsInitialized()) { 
 //BA.debugLineNum = 332;BA.debugLine="Dim v As B4XView = single.Run.View";
_v = new anywheresoftware.b4a.objects.B4XViewWrapper();
_v = _single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ;
...
public String  _organizesinglestyles(com.bwsi.cares.bctextengine._bcparagraph _p) throws Exception{
com.bwsi.cares.bctextengine._bctextline _line = null;
com.bwsi.cares.bctextengine._bcunbreakabletext _un = null;
int _x = 0;
com.bwsi.cares.bctextengine._bcsinglestylesection _single = null;
...
;
for (; index4 < groupLen4;index4++){
_single = (com.bwsi.cares.bctextengine._bcsinglestylesection)(group4.Get(index4));
...
if (_single.GlyphsAndOffsets /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==0 && _single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .View /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .IsInitialized()) { 
...
_par = _single.ParentUN /*com.bwsi.cares.bctextengine._bcunbreakabletext*/ .ParentLine /*com.bwsi.cares.bctextengine._bctextline*/ .ParentParagraph /*com.bwsi.cares.bctextengine._bcparagraph*/ ;
...
_v.setTop((int) (_line.BaselineY /*int*/ /(double)_mscale-_v.getHeight()+_single.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .VerticalOffset /*int*/ ));
...
public String  _organizeunbreakables(com.bwsi.cares.bctextengine._bcparagraph _p,anywheresoftware.b4a.objects.collections.List _unbreakables) throws Exception{
com.bwsi.cares.bctextengine._bcunbreakabletext _un = null;
int _i = 0;
com.bwsi.cares.bctextengine._bcunbreakabletext _nextun = null;
com.bwsi.cares.bctextengine._bcsinglestylesection _singlestyle = null;
int _indent = 0;
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_unbreakables.Get((int) (0)));
...
_nextun = (com.bwsi.cares.bctextengine._bcunbreakabletext)(_unbreakables.Get(_i));
...
_un = (com.bwsi.cares.bctextengine._bcunbreakabletext)(group15.Get(index15));
 //BA.debugLineNum = 521;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(13))";
if (_textcharequals(_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ,BA.ObjectToString(__c.Chr((int) (13))))) { 
if (true) continue;};
 //BA.debugLineNum = 522;BA.debugLine="If TextCharEquals(un.NotFullTextChars, Chr(10))";
if (_textcharequals(_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ,BA.ObjectToString(__c.Chr((int) (10))))) { 
...
if (_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .getSize()>0 && _p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .WordWrap /*boolean*/ ) { 
 //BA.debugLineNum = 527;BA.debugLine="Dim SingleStyle As BCSingleStyleSection = un.Si";
_singlestyle = (com.bwsi.cares.bctextengine._bcsinglestylesection)(_un.SingleStyleSections /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (0)));
 //BA.debugLineNum = 528;BA.debugLine="Dim indent As Int = IndentWidth * SingleStyle.R";
_indent = (int) (_indentwidth*_singlestyle.Run /*com.bwsi.cares.bctextengine._bctextrun*/ .IndentLevel /*int*/ );
 //BA.debugLineNum = 529;BA.debugLine="If p.CurrentLine.Width + mSpaceBetweenCharacter";
if (_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Width /*int*/ +_mspacebetweencharacters+_un.Width /*int*/ +_indent>(_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .MaxWidth /*int*/ -_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getLeft()-_p.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getRight())*_mscale) { 
 //BA.debugLineNum = 530;BA.debugLine="p.CurrentLine.EndsWithSoftLineBreak = True";
_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .EndsWithSoftLineBreak /*boolean*/  = __c.True;
 //BA.debugLineNum = 531;BA.debugLine="CreateLine(p)";
_createline(_p);
 };
 };
 //BA.debugLineNum = 534;BA.debugLine="p.CurrentLine.Unbreakables.Add(un)";
_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_un));
 //BA.debugLineNum = 535;BA.debugLine="un.ParentLine = p.CurrentLine";
_un.ParentLine /*com.bwsi.cares.bctextengine._bctextline*/  = _p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ ;
 //BA.debugLineNum = 536;BA.debugLine="If IsSpace(un.NotFullTextChars) And p.CurrentLin";
if (_isspace(_un.NotFullTextChars /*com.bwsi.cares.bctextengine._bctextchars*/ ) && _p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .getSize()==1) { 
...
if (_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Unbreakables /*anywheresoftware.b4a.objects.collections.List*/ .getSize()>0) { 
_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Width /*int*/  = (int) (_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Width /*int*/ +_mspacebetweencharacters);};
 //BA.debugLineNum = 540;BA.debugLine="un.StartX = p.CurrentLine.Width";
_un.StartX /*int*/  = _p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Width /*int*/ ;
 //BA.debugLineNum = 541;BA.debugLine="p.CurrentLine.Width = p.CurrentLine.Width + un.W";
_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Width /*int*/  = (int) (_p.CurrentLine /*com.bwsi.cares.bctextengine._bctextline*/ .Width /*int*/ +_un.Width /*int*/ );
 }
};
 //BA.debugLineNum = 543;BA.debugLine="End Sub";
return "";
}
public com.bwsi.cares.bctextengine._bcparagraph  _prepare(anywheresoftware.b4a.objects.collections.List _runs,com.bwsi.cares.bctextengine._bcparagraphstyle _style) throws Exception{
com.bwsi.cares.bctextengine._bcparagraph _par = null;
...
_par = new com.bwsi.cares.bctextengine._bcparagraph();
...
_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/  = _style;
...
;
for (; index8 < groupLen8;index8++){
_run = (com.bwsi.cares.bctextengine._bctextrun)(group8.Get(index8));
...
if (_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .RTL /*boolean*/ ) { 
...
public com.bwsi.cares.bctextengine._bcparagraph  _prepareforlazydrawing(anywheresoftware.b4a.objects.collections.List _runs,com.bwsi.cares.bctextengine._bcparagraphstyle _style,anywheresoftware.b4a.objects.B4XViewWrapper _sv) throws Exception{
com.bwsi.cares.bctextengine._bcparagraph _par = null;
int _maxheight = 0;
com.bwsi.cares.bctextengine._bctextline _line = null;
...
_sv.setScrollViewContentHeight((int) (__c.Max(_sv.getHeight()-__c.DipToCurrent((int) (2)),_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getTop()+_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getBottom()+_par.Height /*int*/ /(double)_mscale)));
...
com.bwsi.cares.b4xbitset _arabicchars = null;
com.bwsi.cares.b4xbitset _arabicnonlinked = null;
...
_arabicchars = new com.bwsi.cares.b4xbitset();
_arabicnonlinked = new com.bwsi.cares.b4xbitset();
...
public String  _printtextchars(com.bwsi.cares.bctextengine._bctextchars _tc) throws Exception{
...
__c.LogImpl("916580614",_sb.ToString(),0);
...
public String  _resizeimageview(b4a.example.bitmapcreator _bc,com.bwsi.cares.bctextengine._bcparagraph _par,anywheresoftware.b4a.objects.B4XViewWrapper _iv,boolean _resizeheight) throws Exception{
anywheresoftware.b4a.objects.B4XViewWrapper.B4XBitmapWrapper _bmp = null;
int _ivheight = 0;
...
_ivheight = (int) (__c.Min(_ivheight,_iv.getParent().getHeight()-_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getTop()-_par.Style /*com.bwsi.cares.bctextengine._bcparagraphstyle*/ .Padding /*anywheresoftware.b4a.objects.B4XCanvas.B4XRect*/ .getBottom()));};
...
public boolean  _textcharequals(com.bwsi.cares.bctextengine._bctextchars _tc,String _s) throws Exception{
int _i = 0;
...
public com.bwsi.cares.bctextengine._bctextchars  _textcharssubstring(com.bwsi.cares.bctextengine._bctextchars _tc,int _startindex,int _endindex) throws Exception{
