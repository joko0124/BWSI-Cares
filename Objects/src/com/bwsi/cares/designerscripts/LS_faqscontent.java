...
//BA.debugLineNum = 28;BA.debugLine="pnlFAQ.SetLeftAndRight(0, pnlMain.Width)"[FAQsContent/General script]
views.get("pnlfaq").vw.setLeft((int)(0d));
views.get("pnlfaq").vw.setWidth((int)((views.get("pnlmain").vw.getWidth()) - (0d)));
//BA.debugLineNum = 29;BA.debugLine="pnlFAQ.SetTopAndBottom(Label3.Bottom + 10dip, pnlMain.Bottom - 1%y)"[FAQsContent/General script]
...
//BA.debugLineNum = 31;BA.debugLine="imgTable.SetLeftAndRight(1%x, pnlFAQ.Width - 1%x)"[FAQsContent/General script]
...
//BA.debugLineNum = 32;BA.debugLine="imgTable.SetTopAndBottom(1%y, pnlFAQ.Height - 1%y)"[FAQsContent/General script]
...
//BA.debugLineNum = 33;BA.debugLine="lblQ1.Top = 3%y"[FAQsContent/General script]
views.get("lblq1").vw.setTop((int)((3d / 100 * height)));
//BA.debugLineNum = 34;BA.debugLine="lblQ1.SetLeftAndRight(3%x, imgTable.Width - 2%x)"[FAQsContent/General script]
...
//BA.debugLineNum = 36;BA.debugLine="lblQ2.Top = lblQ1.Bottom + 12dip"[FAQsContent/General script]
views.get("lblq2").vw.setTop((int)((views.get("lblq1").vw.getTop() + views.get("lblq1").vw.getHeight())+(12d * scale)));
//BA.debugLineNum = 37;BA.debugLine="lblQ2.SetLeftAndRight(3%x, imgTable.Width - 2%x)"[FAQsContent/General script]
...
//BA.debugLineNum = 39;BA.debugLine="lblQ3.Top = lblQ2.Bottom + 12dip"[FAQsContent/General script]
views.get("lblq3").vw.setTop((int)((views.get("lblq2").vw.getTop() + views.get("lblq2").vw.getHeight())+(12d * scale)));
//BA.debugLineNum = 40;BA.debugLine="lblQ3.SetLeftAndRight(3%x, imgTable.Width - 2%x)"[FAQsContent/General script]
...
//BA.debugLineNum = 42;BA.debugLine="lblQ4.Top = lblQ3.Bottom + 12dip"[FAQsContent/General script]
views.get("lblq4").vw.setTop((int)((views.get("lblq3").vw.getTop() + views.get("lblq3").vw.getHeight())+(12d * scale)));
//BA.debugLineNum = 43;BA.debugLine="lblQ4.SetLeftAndRight(3%x, imgTable.Width - 2%x)"[FAQsContent/General script]
...
//BA.debugLineNum = 45;BA.debugLine="lblViewAll.Top = lblQ4.Bottom + 8dip"[FAQsContent/General script]
views.get("lblviewall").vw.setTop((int)((views.get("lblq4").vw.getTop() + views.get("lblq4").vw.getHeight())+(8d * scale)));
//BA.debugLineNum = 46;BA.debugLine="lblViewAll.SetLeftAndRight(3%x, imgTable.Width-1%x)"[FAQsContent/General script]
